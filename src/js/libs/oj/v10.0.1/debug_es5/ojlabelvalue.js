 ...
 * @ignore
 */
define(['ojs/ojcore', 'ojs/ojcomponentcore', 'ojs/ojlabel', 'ojs/ojcore-base'], function (ojcore, ojcomponentcore, ojlabel, oj) {
  'use strict';
    ...
    function _getLabelWidth(customElementAncestor) {
      ...
      if (element.labelWidth === 'inherit') {
        ...
        if (customElementAncestor && 'labelWidth' in customElementAncestor) {
          labelWidth = customElementAncestor.labelWidth; // for units that are (or can be) relative to horizontal screen size.
          ...
          switch (parts[2]) {
            ...
            case '%':
              ...
              var columnGap = element.getAttribute('data-oj-column-gap'); // if it is 0, then the parent component didn't update this and we use the default.
  ...
  (function () {
    var __oj_label_value_metadata = {
      "properties": {
        ...
        "labelEdge": {
          "type": "string",
          "enumValues": ["inherit", "inside", "start", "top"],
          "value": "inherit"
        },
        "labelWidth": {
          "type": "string",
