 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'ojs/ojcomponentcore', 'jquery', 'ojs/ojpictochart-toolkit', 'ojs/ojdvt-base'], function (oj, ojcomponentcore, $, ojpictochartToolkit, ojdvtBase) {
  'use strict';
  ...
  (function () {
    var __oj_picto_chart_metadata = {
      "properties": {
        ...
        "animationOnDisplay": {
          "type": "string",
          "enumValues": ["alphaFade", "auto", "none", "popIn", "zoom"],
          "value": "none"
        },
        "as": {
          "type": "string",
        ...
        "layoutOrigin": {
          "type": "string",
          "enumValues": ["bottomEnd", "bottomStart", "topEnd", "topStart"],
          "value": "topStart"
        },
        "rowCount": {
          "type": "number"
    ...
    oj.CustomElementBridge.register('oj-picto-chart', {
      metadata: __oj_picto_chart_metadata
    });
  })();
  ...
  oj.__registerWidget('oj.ojPictoChart', $.oj.dvtBaseComponent, {
    ...
    _GetChildStyleClasses: function _GetChildStyleClasses() {
      ...
      styleClasses['oj-pictochart-item'] = {
        path: '_defaultColor',
        property: 'background-color'
      };
      styleClasses['oj-dvtbase oj-pictochart'] = {
        path: 'animationDuration',
        property: 'ANIM_DUR'
      };
      styleClasses['oj-dvt-selectable-inner-shape'] = {
        path: '_innerColor',
        property: 'stroke'
      };
      styleClasses['oj-dvt-selectable oj-selected'] = {
        path: '_outerColor',
        property: 'stroke'
      };
      return styleClasses;
