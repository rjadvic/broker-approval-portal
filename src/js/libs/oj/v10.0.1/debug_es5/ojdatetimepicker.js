...
define(['ojs/ojcore', 'jquery', 'ojs/ojeditablevalue', 'ojs/ojinputtext', 'ojs/ojconverterutils', 'ojs/ojanimation', 'ojs/ojpopup', 'ojs/ojbutton', 'ojs/ojcore-base', 'hammerjs', 'ojs/ojcomponentcore', 'ojs/ojconverterutils-i18n', 'ojs/ojvalidator-datetimerange', 'ojs/ojvalidator-daterestriction', 'ojs/ojconverter-datetime', 'ojs/ojlocaledata', 'ojs/ojlogger', 'ojs/ojthemeutils', 'ojs/ojcontext', 'ojs/ojfocusutils', 'ojs/ojdomutils', 'ojs/ojconfig'], function (ojcore, $, ojeditablevalue, ojinputtext, ojconverterutils, ojanimation, ojpopup, ojbutton, oj, Hammer, ojcomponentcore, ojconverterutilsI18n, DateTimeRangeValidator, DateRestrictionValidator, ojconverterDatetime, ojlocaledata, ojlogger, ojthemeutils, Context, FocusUtils, DomUtils, ojconfig) {
      ...
      "properties": {
        ...
        "datePicker": {
          ...
          "properties": {
            ...
            "daysOutsideMonth": {
              "type": "string",
              "enumValues": ["hidden", "selectable", "visible"],
              "value": "hidden"
            },
            "footerLayout": {
              "type": "string",
  ...
  var _defaultOptions = ojthemeutils.parseJSONFromFontFamily('oj-inputdatetime-option-defaults') || {};
  ...
  function _getNativePickerDate(converter, isoString) {
    ...
    try {
      valueParams = ojconverterutilsI18n.IntlConverterUtils._dateTime(isoString, ['date', 'fullYear', 'month', 'hours', 'minutes', 'seconds'], true);
    } catch (e) {
      ojlogger.info('The value of the InputDateTime element should be an ISOString, please use a valid ISOString');
      date.setHours(0);
      date.setMinutes(0);
      date.setSeconds(0);
  ...
  var yearDisplay = new ojconverterDatetime.IntlDateTimeConverter({
    year: 'numeric'
  });

  function formatYear(year, month) {
    return yearDisplay.format(ojconverterutilsI18n.IntlConverterUtils.dateToLocalIso(new Date(year, month, 1)));
  }
  /**
  ...
  * @memberof! oj.ojInputDate
  ...
  oj.__registerWidget('oj.ojInputDate', $.oj.inputBase, {
    ...
    options: {
       ...
       */
      converter: new ojconverterDatetime.IntlDateTimeConverter({
        day: '2-digit',
        month: '2-digit',
        year: _yearFormat
      }),
    ...
    */
    ...
    _datepickerShowing: function _datepickerShowing() {
      return this._isInLine || this._popUpDpDiv && ojcomponentcore.isComponentInitialized(this._popUpDpDiv, 'ojPopup') && this._popUpDpDiv.ojPopup('isOpen') || this._nativePickerShowing;
    },
    ...
    _changeCurrentDay: function _changeCurrentDay() {
      ...
      if (cOver.length === 0) {
        cOver = $('span.oj-disabled:contains(' + this._currentDay + ')', datePickerCalendar).filter(function () {
          return $(this).text() === cDay;
        });
      }
      ...
      if (cOver.length === 1) {
        ...
        cParent.addClass(this._DAYOVER_CLASS); // This is needed only for zoom % 400 or above. Without if condition, it makes the page move when
    ...
    _updateDatepicker: function _updateDatepicker(focusOnCalendar, view, navigation) {
      ...
      var selectors = '.oj-datepicker-prev-icon.oj-enabled, .oj-datepicker-next-icon.oj-enabled,' + '.oj-datepicker-current, .oj-datepicker-month, .oj-datepicker-year, .oj-datepicker-calendar td a';

      this._dpDiv.find(selectors).click(function (e) {
        e.preventDefault();
      });
    },
    ...
    _getCurrentDate: function _getCurrentDate() {
      ...
      var converterOptions = converter && converter.resolvedOptions ? converter.resolvedOptions() : null;

      if (converterOptions && converterOptions.timeZone && converterOptions.isoStrFormat !== 'local') {
        date = ojconverterutilsI18n.IntlConverterUtils.isoToLocalDate(converter.parse(date.toISOString()));
      }
    ...
    _generateHeader: function _generateHeader(drawMonth, drawYear, monthControl, enablePrev, enableNext) {
      ...
      var prev = enablePrev ? "<a role='button' href='#'" + " class='oj-datepicker-prev-icon oj-enabled oj-default oj-component-icon" + " oj-clickable-icon-nocontext'" + " data-handler='prev' data-event='click keydown'" + " aria-label='" + prevText + "'></a>" : "<a class='oj-datepicker-prev-icon oj-disabled oj-component-icon" + " oj-clickable-icon-nocontext' title='" + prevText + "'></a>";

      var nextText = this._EscapeXSS(this.getTranslatedString('nextText'));

      var next = enableNext ? "<a role='button' href='#'" + " class='oj-datepicker-next-icon oj-enabled oj-default oj-component-icon" + " oj-clickable-icon-nocontext' data-handler='next' data-event='click keydown'" + " aria-label='" + nextText + "'></a>" : "<a class='oj-datepicker-next-icon oj-disabled oj-component-icon" + " oj-clickable-icon-nocontext' title='" + nextText + "'></a>";
    ...
    _generateFooter: function _generateFooter(footerLayoutDisplay, gotoDate) {
      ...
      var todayControl = "<a role='button' href='#'" + " class='oj-datepicker-current oj-priority-secondary " + (this._IsDisabled() ? "oj-disabled' disabled" : "oj-enabled'") + " data-handler='today' data-event='click keydown'>" + currentText + '</a>';
    ...
    _generateViewHTML: function _generateViewHTML(view) {
      ...
      var tempDate = this._getCurrentDate();
    ...
    _generateMonthYearHeader: function _generateMonthYearHeader(drawMonth, drawYear) {
      ...
      var positionOfMonthToYear = ojlocaledata.isMonthPriorToYear() ? 'before' : 'after';
      ...
      if (this._datepickerShowing()) {
        switch (event.keyCode) {
          ...
          case kc.DOWN:
            ...
            var tabStop = FocusUtils.focusFirstTabStop(datePickerCalElem); // if we don't find a tab stop, we'll focus on the whole calendar like before.
    ...
    */
    ...
    _ShowNativeDatePicker: function _ShowNativeDatePicker(pickerOptions) {
      ...
      function onError(error) {
        ...
        if (error.startsWith('cancel')) {
          ...
          ojlogger.error('Error: native date or time picker failed: ' + error);
        }
      }
    ...
    _validateDatetime: function _validateDatetime(isoString, actionParam, doParseValue) {
      ...
      try {
        ...
        ojlogger.info('The value of the InputDate element should be an ISOString, please use a valid ISOString');
        valueParams = ojconverterutilsI18n.IntlConverterUtils._dateTime(this._getDefaultIsoDate(), actionParam, doParseValue);
      }
  ...
  ojcomponentcore.setDefaultOptions({
    ojInputDate: {
      firstDayOfWeek: ojcomponentcore.createDynamicPropertyGetter(function () {
        return ojlocaledata.getFirstDayOfWeek();
      }),
      dayWide: ojcomponentcore.createDynamicPropertyGetter(function () {
        return ojlocaledata.getDayNames('wide');
      }),
      dayNarrow: ojcomponentcore.createDynamicPropertyGetter(function () {
        return ojlocaledata.getDayNames('narrow');
      }),
      monthWide: ojcomponentcore.createDynamicPropertyGetter(function () {
        return ojlocaledata.getMonthNames('wide');
      }),
      monthAbbreviated: ojcomponentcore.createDynamicPropertyGetter(function () {
        return ojlocaledata.getMonthNames('abbreviated');
      }),
      datePicker: ojcomponentcore.createDynamicPropertyGetter(function () {
        return (ojthemeutils.parseJSONFromFontFamily('oj-inputdatetime-option-defaults') || {}).datePicker;
      }),
      renderMode: ojcomponentcore.createDynamicPropertyGetter(function () {
        return (ojthemeutils.parseJSONFromFontFamily('oj-inputdatetime-option-defaults') || {}).renderMode;
      }),
      keyboardEdit: ojcomponentcore.createDynamicPropertyGetter(function () {
        return (ojthemeutils.parseJSONFromFontFamily('oj-inputdatetime-option-defaults') || {}).keyboardEdit;
      })
    }
  }); // Fragments:
  ...
  */
      ...
      Object.defineProperty(self, 'isoMin', {
        ...
        set: function set(iso) {
          ...
          if (!isNaN(newMin)) {
            ...
            ojlogger.error('Invalid ISO min time: %s', iso);
          }
        }
      });
      ...
      Object.defineProperty(self, 'isoMax', {
        ...
        set: function set(iso) {
          ...
          if (!isNaN(newMax)) {
            ...
            ojlogger.error('Invalid ISO max time: %s', iso);
          }
        }
      });
      Object.defineProperty(self, 'value', {
      ...
      Object.defineProperty(self, 'isoValue', {
        ...
        set: function set(iso) {
          ...
          if (!isNaN(newValue)) {
            ...
            ojlogger.error('Invalid ISO value time: %s', iso);
          }
        }
      });
    ...
    function createWheels() {
      ...
      for (i = 0; i < codes.length; i++) {
        switch (codes[i]) {
          ...
          default:
            ojlogger.error('Unknown wheelOrder code: %s', codes[i]);
            break;
        }
      }
  ...
  var _defaultOptions$1 = ojthemeutils.parseJSONFromFontFamily('oj-inputdatetime-option-defaults') || {};
  ...
  * @memberof! oj.ojInputTime
  ...
  oj.__registerWidget('oj.ojInputTime', $.oj.inputBase, {
    ...
    _InitOptions: function _InitOptions(originalDefaults, constructorOptions) {
      ...
      if (this.options.datePickerComp === null && !this._IsCustomElement()) {
        ojeditablevalue.EditableValueUtils.initializeOptionsFromDom(this._GET_INIT_OPTIONS_PROPS_FOR_WIDGET, constructorOptions, this);
      }
    },
    ...
    _createWheelPicker: function _createWheelPicker() {
      ...
      if (this._isIndependentInput()) {
        ...
        if (pickerAttrs) {
          ojeditablevalue.EditableValueUtils.setPickerAttributes(this._popUpWheelPicker.ojPopup('widget'), pickerAttrs);
        }
      }
    },
    _timepickerShowing: function _timepickerShowing() {
      ...
      if (this._isIndependentInput()) {
        ...
        return picker && ojcomponentcore.isComponentInitialized(picker, 'ojPopup') && picker.ojPopup('isOpen') || this._nativePickerShowing;
      }

      var widget = this._datePickerComp.widget;
      picker = widget._popUpDpDiv;
      return widget._isShowingDatePickerSwitcher() && picker && ojcomponentcore.isComponentInitialized(picker, 'ojPopup') && picker.ojPopup('isOpen') || this._nativePickerShowing;
    },
    ...
    _showNativeTimePicker: function _showNativeTimePicker() {
      ...
      if (minDate) {
        ...
        var minDateProcessed = _getNativePickerDate(converter, ojconverterutilsI18n.IntlConverterUtils._minMaxIsoString(minDate, this._getIsoDateValue(converter)));
      ...
      if (maxDate) {
        // get a correctly formatted ISO date string
        var maxDateProcessed = _getNativePickerDate(converter, ojconverterutilsI18n.IntlConverterUtils._minMaxIsoString(maxDate, this._getIsoDateValue(converter)));
      ...
      function onError(error) {
        ...
        if (error.startsWith('cancel')) {
          ...
          ojlogger.error('Error: native time picker failed: ' + error);
        }
      }
    ...
    _generateHeader: function _generateHeader() {
      ...
      var cancelButton = "<a role='button' href='#'" + " class='oj-enabled oj-default oj-timepicker-cancel-button'" + " aria-label='" + cancelText + "'>" + cancelText + '</a>';

      var okText = this._EscapeXSS(this.getTranslatedString('okText'));

      var okButton = "<a role='button' href='#'" + " class='oj-enabled oj-default oj-timepicker-ok-button' aria-label='" + okText + "'>" + okText + '</a>';
    ...
    _getIsoDateLimit: function _getIsoDateLimit(converter, optionName, valueDate) {
      ...
      dateIso = dateIso ? ojconverterutilsI18n.IntlConverterUtils._minMaxIsoString(dateIso, this._getValue()) : dateIso; // Move to the converter's timezone
    ...
    _getAmPmStrings: function _getAmPmStrings() {
      var converter = new ojconverterDatetime.IntlDateTimeConverter({
        pattern: 'a'
      });
      return [converter.format('2016-01-01T01:00:00'), converter.format('2016-01-01T13:00:00')];
    },
    ...
    _createWheelPickerDom: function _createWheelPickerDom(keepHeaderFooter) {
      ...
      try {
        ...
        ojlogger.info('The value of the InputTime element should be an ISOString, please use a valid ISOString');
        value = ojconverterutilsI18n.IntlConverterUtils.dateToLocalIso(date);
        valueDate = converterUtils._clearTime(value);
      }
  ...
  ojcomponentcore.setDefaultOptions({
    ojInputTime: {
      ...
      timePicker: ojcomponentcore.createDynamicPropertyGetter(function () {
        return (ojthemeutils.parseJSONFromFontFamily('oj-inputdatetime-option-defaults') || {}).timePicker;
      })
    }
  }); // Fragments:
  ...
  var _defaultOptions$2 = ojthemeutils.parseJSONFromFontFamily('oj-inputdatetime-option-defaults') || {};
  ...
  * @memberof! oj.ojInputDateTime
  ...
  oj.__registerWidget('oj.ojInputDateTime', $.oj.ojInputDate, {
    ...
    _createTimePicker: function _createTimePicker() {
      ...
      var messagesDisplayOption = this._isInLine ? this.options.displayOptions.messages : 'none'; // create time instance for the time portion
