 ...
 * @ignore
 */
define(['exports', 'ojs/ojcore-base', 'ojL10n!ojtranslations/nls/localeElements'], function (exports, oj, ojldimport) {
  'use strict';
  ...
  var getDayNames = LocaleData.getDayNames;
  var getFirstDayOfWeek = LocaleData.getFirstDayOfWeek;
  var getMonthNames = LocaleData.getMonthNames;
  var getWeekendEnd = LocaleData.getWeekendEnd;
  var getWeekendStart = LocaleData.getWeekendStart;
  var isMonthPriorToYear = LocaleData.isMonthPriorToYear;
  var setBundle = LocaleData.setBundle;
  var __getBundle = LocaleData.__getBundle;
