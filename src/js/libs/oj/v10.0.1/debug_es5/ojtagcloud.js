 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'ojs/ojcomponentcore', 'jquery', 'ojs/ojdvt-base', 'ojs/ojtagcloud-toolkit'], function (oj, Components, $, ojdvtBase, ojtagcloudToolkit) {
  'use strict';
  ...
  */
  ...
  (function () {
    ...
    oj.CustomElementBridge.register('oj-tag-cloud', {
      metadata: __oj_tag_cloud_metadata
    });
  })();
  ...
  oj.__registerWidget('oj.ojTagCloud', $.oj.dvtBaseComponent, {
    ...
    _GetChildStyleClasses: function _GetChildStyleClasses() {
      ...
      styleClasses['oj-tagcloud'] = {
        path: 'styleDefaults/svgStyle',
        property: 'TEXT'
      };
      return styleClasses;
    },
