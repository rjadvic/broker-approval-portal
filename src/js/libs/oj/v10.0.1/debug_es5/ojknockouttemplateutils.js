...
define(['exports', 'knockout', 'jquery'], function (exports, ko, $) {
  ...
  KnockoutTemplateUtils.getRenderer = function (template, bReplaceNode) {
    var templateRenderer = function templateRenderer(context) {
      ...
      var bindingContext = ko.contextFor(context.componentElement); // Make sure we have a bindingContext before rendering.  It's possible that this is called
    ...
    return function (context) {
      if (context.componentElement.classList && context.componentElement.classList.contains('oj-dvtbase')) {
        ...
        Object.defineProperty(context, '_parentElement', {
          value: dummyDiv,
          enumerable: false
        });
  ...
  var getRenderer = KnockoutTemplateUtils.getRenderer;
