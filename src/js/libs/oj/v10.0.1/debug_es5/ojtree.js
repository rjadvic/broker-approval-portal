 ...
 * @ignore
 */
define(['ojs/ojcore', 'jquery', 'ojs/ojcontext', 'ojs/ojcomponentcore', 'ojs/ojdomutils', 'ojdnd'], function (oj, $, Context, Components, DomUtils) {
  "use strict";
  ...
  oj.TreeDndContext.prototype._dndFinishReorder = function (e) {
    ...
    if (dnd.dragStarted && dnd.reorder && _typeof(vars.o) === 'object' && vars.o.length > 0) {
      this.component._moveNode(vars.o, vars.r, vars.last_pos, DomUtils.isMetaKeyPressed(e)); // Don't want dragEnd() to do any node(s) removal since they have just been
      // moved  by tree
    ...
    oj.__registerWidget('oj.ojTree', $.oj.baseComponent, {
      ...
      */
      ...
      _select: function _select(node, check, e) {
        ...
        var isMultiple = selMultMod === 'on' || selMultMod !== false && e && DomUtils.isMetaKeyPressed(e);
