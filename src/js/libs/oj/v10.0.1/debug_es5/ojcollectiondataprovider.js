 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'ojs/ojcollectiontabledatasource', 'ojs/ojdataprovideradapter'], function (oj, ojcollectiontabledatasource, ojdataprovideradapter) {
  'use strict';
  ...
  var CollectionDataProvider = /*#__PURE__*/function () {
    function CollectionDataProvider(collection) {
      ...
      this._dataProviderAdapter = new oj.TableDataSourceAdapter(new ojcollectiontabledatasource.CollectionTableDataSource(collection));
