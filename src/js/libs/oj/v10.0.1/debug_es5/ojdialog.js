    ...
    oj.__registerWidget('oj.ojDialog', $.oj.baseComponent, {
      ...
      _keydownHandler: function _keydownHandler(event) {
        ...
        if (!event.shiftKey) {
          ...
          if (FocusUtils.isLastActiveElement(this.element) || document.activeElement === this.element[0]) {
        ...
        } else if (FocusUtils.isFirstActiveElement(this.element) || document.activeElement === this.element[0]) {
      ...
      _setWhenReady: function _setWhenReady(operation) {
        ...
        this._whenReadyMediator = new ojpopupcore.PopupWhenReadyMediator(this.element, operation, 'ojDialog', this._IsCustomElement());
      },
