 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'ojs/ojcomponentcore', 'ojs/ojdvt-base', 'jquery', 'ojs/ojlegend-toolkit', 'ojs/ojkeyset'], function (oj, Components, DvtAttributeUtils, $, ojlegendToolkit, ojkeyset) {
  'use strict';
  ...
  var __oj_legend_item_metadata = {
    "properties": {
      ...
      "symbolType": {
        "type": "string",
        "enumValues": ["image", "line", "lineWithMarker", "marker"],
        "value": "marker"
      },
      "text": {
        "type": "string",
  ...
  */
  ...
  oj.__registerWidget('oj.ojLegend', $.oj.dvtBaseComponent, {
    ...
    _GetChildStyleClasses: function _GetChildStyleClasses() {
      var styleClasses = this._super(); // Should be kept in sync with chart DvtLegend
