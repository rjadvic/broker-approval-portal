 ...
 * @ignore
 */
define(['require', 'ojs/ojcomponentcore', 'ojs/ojcore-base', 'ojs/ojdvt-base', 'jquery', 'ojs/ojthematicmap-toolkit', 'ojs/ojlogger', 'ojs/ojconfig'], function (require, Components, oj, DvtAttributeUtils, $, ojthematicmapToolkit, Logger, Config) {
  'use strict';
  ...
  var __oj_thematic_map_metadata = {
    "properties": {
      ...
      "tooltipDisplay": {
        "type": "string",
        "enumValues": ["auto", "labelAndShortDesc", "none", "shortDesc"],
        "value": "auto"
      },
      "touchResponse": {
        "type": "string",
  ...
  oj.__registerWidget('oj.ojThematicMap', $.oj.dvtBaseComponent, {
    ...
    _loadResourceByUrl: function _loadResourceByUrl(url, bRenderOnFail) {
      ...
      new Promise(function (resolve, reject) {
        require(['../' + Config.getResourceUrl(url)], function (m) {
          resolve(_interopNamespace(m));
        }, reject);
      }).then(renderCallback, bRenderOnFail ? renderCallback : null);
    },
    ...
    _loadBasemapHelper: function _loadBasemapHelper(basemap, layer, locale) {
      ...
      try {
        ...
        isLoaded = Object.keys(ojthematicmapToolkit.ThematicMap.DvtBaseMapManager.getLayerIds(basemap, layer)).length > 0;
      } catch (err) {
        isLoaded = false;
      }
