 ...
 * @ignore
 */
define(['exports', 'knockout', 'jquery', 'ojs/ojcore-base', 'ojs/ojdomutils', 'ojs/ojthemeutils', 'ojs/ojanimation'], function (exports, ko, $, oj, DomUtils, ThemeUtils, AnimationUtils) {
  'use strict';
  ...
  ModuleAnimations.createAnimation = function (oldViewEffect, newViewEffect, newViewOnTop) {
    return {
      ...
      prepareAnimation: function prepareAnimation(context) {
        var viewParents = {};
      ...
      animate: function animate(context) {
  ...
  ModuleAnimations._getModuleEffect = function (animateName) {
    if (ModuleAnimations._moduleEffects == null) {
      ModuleAnimations._moduleEffects = ThemeUtils.parseJSONFromFontFamily('oj-animation-module-effects');
    }
  ...
  ModuleAnimations._getImplementation = function (animateName) {
    ...
    if (descriptor) {
      return ModuleAnimations.createAnimation(descriptor.oldViewEffect, descriptor.newViewEffect, descriptor.newViewOnTop);
    }
  ...
  ModuleAnimations._getNavigateMethod = function (context, navigationType) {
    if (ModuleAnimations._navigateMethods == null) {
      ModuleAnimations._navigateMethods = ThemeUtils.parseJSONFromFontFamily('oj-animation-navigate-methods');
    }
  ...
  ModuleAnimations._navigateCanAnimate = function (context, navigationType) {
    ...
    if (ModuleAnimations[animateName]) {
      return ModuleAnimations[animateName].canAnimate == null || ModuleAnimations[animateName].canAnimate(context);
    }
  ...
  ModuleAnimations._getNavigateImplementation = function (navigationType) {
    return {
      canAnimate: function canAnimate(context) {
  ...
  ModuleAnimations.coverStart = DomUtils.getReadingDirection() === 'rtl' ? ModuleAnimations.coverRight : ModuleAnimations.coverLeft;
  /**
   * ModuleAnimation implementation for changing views by
  ...
  ModuleAnimations.revealEnd = DomUtils.getReadingDirection() === 'rtl' ? ModuleAnimations.revealLeft : ModuleAnimations.revealRight;
  /**
   * ModuleAnimation implementation for changing views by
  ...
  ModuleAnimations.navSiblingEarlier = ModuleAnimations._getNavigateImplementation('navSiblingEarlier');
  /**
  ...
  ModuleAnimations.switcher = function (callback) {
    ...
    var AnimateProxy = function AnimateProxy() {
      ...
      function _getDelegateInvoker(name) {
        var invoker = function invoker(context) {
  ...
  var createAnimation = ModuleAnimations.createAnimation;
  var coverLeft = ModuleAnimations.coverLeft;
  var coverRight = ModuleAnimations.coverRight;
  var revealLeft = ModuleAnimations.revealLeft;
  var revealRight = ModuleAnimations.revealRight;
  var coverStart = ModuleAnimations.coverStart;
  var revealEnd = ModuleAnimations.revealEnd;
  var coverUp = ModuleAnimations.coverUp;
  var revealDown = ModuleAnimations.revealDown;
  var zoomIn = ModuleAnimations.zoomIn;
  var zoomOut = ModuleAnimations.zoomOut;
  var fade = ModuleAnimations.fade;
  var pushStart = ModuleAnimations.pushStart;
  var pushEnd = ModuleAnimations.pushEnd;
  var navChild = ModuleAnimations.navChild;
  var navParent = ModuleAnimations.navParent;
  var drillIn = ModuleAnimations.drillIn;
  var drillOut = ModuleAnimations.drillOut;
  var navSiblingEarlier = ModuleAnimations.navSiblingEarlier;
  var navSiblingLater = ModuleAnimations.navSiblingLater;
  var switcher = ModuleAnimations.switcher;
