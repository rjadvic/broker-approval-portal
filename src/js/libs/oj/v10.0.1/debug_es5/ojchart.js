 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'ojs/ojdvt-base', 'ojs/ojcomponentcore', 'jquery', 'ojs/ojconverterutils-i18n', 'ojs/ojconverter-number', 'ojs/ojlogger', 'ojs/ojmap', 'ojs/ojchart-toolkit'], function (oj, DvtAttributeUtils, ojcomponentcore, $, ConverterUtils, NumberConverter, Logger, ojMap, ojchartToolkit) {
  'use strict';
  ...
  */
  ...
  var __oj_chart_metadata = {
    "properties": {
      "animationOnDataChange": {
        "type": "string",
        "enumValues": ["auto", "none", "slideToLeft", "slideToRight"],
        "value": "none"
      },
      "animationOnDisplay": {
        "type": "string",
        "enumValues": ["alphaFade", "auto", "none", "zoom"],
        "value": "none"
      },
      "as": {
        "type": "string",
      ...
      "dragMode": {
        "type": "string",
        "enumValues": ["off", "pan", "select", "user", "zoom"],
        "value": "user"
      },
      "drilling": {
        "type": "string",
        "enumValues": ["groupsOnly", "off", "on", "seriesOnly"],
        "value": "off"
      },
      "groupComparator": {
        "type": "function"
      ...
      "hideAndShowBehavior": {
        "type": "string",
        "enumValues": ["none", "withRescale", "withoutRescale"],
        "value": "none"
      },
      "highlightMatch": {
        "type": "string",
      ...
      "legend": {
        ...
        "properties": {
          ...
          "position": {
            "type": "string",
            "enumValues": ["auto", "bottom", "end", "start", "top"],
            "value": "auto"
          },
      ...
      "pieCenter": {
        ...
        "properties": {
          ...
          "scaling": {
            "type": "string",
            "enumValues": ["auto", "billion", "million", "none", "quadrillion", "thousand", "trillion"],
            "value": "auto"
          }
        }
      },
      ...
      "styleDefaults": {
        ...
        "properties": {
          ...
          "dataLabelCollision": {
            "type": "string",
            "enumValues": ["fitInBounds", "none"],
            "value": "none"
          },
          "dataLabelPosition": {
            "type": "string|Array<string>",
            "enumValues": ["aboveMarker", "afterMarker", "auto", "beforeMarker", "belowMarker", "center", "insideBarEdge", "none", "outsideBarEdge", "outsideSlice"],
            "value": "auto"
          },
          "dataLabelStyle": {
            "type": "object|Array<Object>"
          ...
          "selectionEffect": {
            "type": "string",
            "enumValues": ["explode", "highlight", "highlightAndExplode"],
            "value": "highlight"
          },
          "seriesEffect": {
            "type": "string",
            "enumValues": ["color", "gradient", "pattern"],
            "value": "color"
          },
          "shapes": {
            "type": "Array<string>"
      ...
      "timeAxisType": {
        "type": "string",
        "enumValues": ["auto", "disabled", "enabled", "mixedFrequency", "skipGaps"],
        "value": "auto"
      },
      "tooltip": {
        "type": "object",
      ...
      "type": {
        "type": "string",
        "enumValues": ["area", "bar", "boxPlot", "bubble", "combo", "funnel", "line", "lineWithArea", "pie", "pyramid", "scatter", "stock"],
        "value": "bar"
      },
      "valueFormats": {
        "type": "object",
      ...
      "zoomAndScroll": {
        "type": "string",
        "enumValues": ["delayed", "delayedScrollOnly", "live", "liveScrollOnly", "off"],
        "value": "off"
      },
      "zoomDirection": {
        "type": "string",
  ...
  (function () {
    ...
    var chartParseFunction = function chartParseFunction(value, name, metadata, defaultParseFunction) {
  ...
  var __oj_chart_item_metadata = {
    "properties": {
      ...
      "pattern": {
        "type": "string",
        "enumValues": ["auto", "largeChecker", "largeCrosshatch", "largeDiagonalLeft", "largeDiagonalRight", "largeDiamond", "largeTriangle", "smallChecker", "smallCrosshatch", "smallDiagonalLeft", "smallDiagonalRight", "smallDiamond", "smallTriangle"],
        "value": "auto"
      },
      "q1": {
        "type": "number"
  ...
  var __oj_spark_chart_metadata = {
    "properties": {
      ...
      "lineType": {
        "type": "string",
        "enumValues": ["centeredSegmented", "centeredStepped", "curved", "none", "segmented", "stepped", "straight"],
        "value": "straight"
      },
      "lineWidth": {
        "type": "number",
      ...
      "type": {
        "type": "string",
        "enumValues": ["area", "bar", "line", "lineWithArea"],
        "value": "line"
      },
      "visualEffects": {
        "type": "string",
  ...
  */
  ...
  var ChartDataProviderHandler = function ChartDataProviderHandler(component, templateEngine, items, dataProperty) {
  ...
  ChartDataProviderHandler.prototype.Init = function () {
    ...
    this._groupComparator = this._component.options.groupComparator; // item map. key: series+group ids, value: corresponding item

    this._itemMap = new Map(); // seriesContexts: conatins series context for each series

    this._seriesContexts = new Map(); // groupContexts: contains the group context for a each level of each group

    this._groupContexts = new Map(); // Generate chart data

    var numSeries = 0;
    var numOuterGroups = 0; // stamp out chart item templates and collect chart item nodes

    this._chartDataItems = [];

    for (var i = 0; i < this._items.length; i++) {
      var item = this._items[i]; // only process unique rows. ie item keys not seen yet

      if (!this._itemMap.has(item.seriesId) || !this._itemMap.get(item.seriesId).has(item.groupId)) {
        ...
        this._seriesContexts.get(seriesId).items.push(itemContext); // While processing each data row, pull out each groupId and generate/update groupContext for each group/nested group
        ...
        this._addToGroupContexts(itemContext, groupId, 1, count); // make a map of series+group ids to their corresponding items
    ...
    if (this._chartDataItems.length > 0) {
      // Create chart groups
      this._groups = this._createGroups(); // Sort groups
      ...
      this._series = this._createSeries(this._groups); // Sort series
  ...
  ChartDataProviderHandler.prototype._addToGroupContexts = function (itemContext, groupId, depth, count) {
      ...
      try {
        if (!hasError) {
          ...
          if (this._seriesTemplate) {
            _chartDataSeries = this._templateHandler.processNodeTemplate(this._dataProperty, this._templateEngine, this._seriesTemplate, 'oj-chart-series', seriesContext, seriesId);
          } else {
            _chartDataSeries = {};
          }
  ...
  ChartDataProviderHandler.prototype._addItemsToSeries = function (chartSeriesData, chartGroupsData) {
    var getGroupKeys = function getGroupKeys(group) {
      if (!group.groups) {
        return [group.id];
      }
    ...
    var groupKeys = [];
    var i; // get group keys. the groupKeys indices corresponds to chart item indices
      ...
      try {
        if (!hasError) {
          ...
          if (this._groupTemplate) {
            groupItem = this._templateHandler.processNodeTemplate(this._dataProperty, this._templateEngine, this._groupTemplate, 'oj-chart-group', groupContext, currentGroupId);
          } else {
            groupItem = {};
          }
  ...
  ChartDataProviderHandler.prototype._addGroupItem = function (item, groupId, groupsArray, chartGroupItems) {
    if (!groupsArray) {
      // eslint-disable-next-line no-param-reassign
      groupsArray = [];
    }

    var currentGroupId = groupId[0]; // check to see if we're adding to an existing group
    ...
    if (groupId.length > 1) {
      // not a leaf, add the next level of groups
      groupItem.groups = this._addGroupItem(item, groupId.slice(1), groupItem.groups, chartGroupItems);
    }
  ...
  ChartDataProviderHandler.prototype._sortSeries = function (seriesArray) {
    var sortFunction = function sortFunction(seriesContexts, seriesComparator) {
      return function (a, b) {
        return seriesComparator(seriesContexts.get(a.id), seriesContexts.get(b.id));
      };
    };

    seriesArray.sort(sortFunction(this._seriesContexts, this._seriesComparator)); // Update seriesContext indices after sort
  ...
  ChartDataProviderHandler.prototype._sortGroups = function (groupsArray) {
    var sortFunction = function sortFunction(groupContexts, groupComparator) {
      return function (a, b) {
        var id1 = a.id;
        var id2 = b.id;
    ...
    for (var i = 0; i < groupsArray.length; i++) {
      var groupId = groupsArray[i].id; // Update group context indices after sorting

      this._groupContexts.get(groupId).index = i; // Sort nested groups if they exist
  ...
  oj.__registerWidget('oj.ojChart', $.oj.dvtBaseComponent, {
    ...
    _ProcessTemplates: function _ProcessTemplates(dataProperty, data, templateEngine, isTreeData, parentKey, isRoot, updateChildren) {
      ...
      if (!results) {
        ...
        var items = this._super(dataProperty, data, templateEngine, isTreeData, parentKey, isRoot, updateChildren);

        var chartOptions = new ChartDataProviderHandler(this, templateEngine, items.values[0], dataProperty);
        results = {
          paths: ['series', 'groups'],
          values: [chartOptions.getSeries(), chartOptions.getGroups()]
        };
    ...
    _ProcessOptions: function _ProcessOptions() {
      ...
      var selection = this.options.selection; // The array<Object> type is deprecated since 2.1.0 so for custom elements and only supported for the data provider use case starting 5.1.0
      // we are breaking selection in order to push developers to use the correct syntax

      if (this._IsCustomElement() && selection && _typeof(selection[0]) === 'object' && !this.options.data) {
    ...
    _GetComponentRendererOptions: function _GetComponentRendererOptions() {
      return [{
        ...
        path: 'pieCenter/renderer',
        slot: 'pieCenterTemplate'
      }];
    },
    //* * @inheritdoc */
    ...
    _GetChildStyleClasses: function _GetChildStyleClasses() {
      ...
      styleClasses['oj-chart-data-cursor-line'] = [{
        path: 'styleDefaults/dataCursor/lineColor',
        property: 'color'
      }, {
        path: 'styleDefaults/dataCursor/lineWidth',
        property: 'width'
      }];
      ...
      styleClasses['oj-chart-xaxis-title'] = {
        path: 'xAxis/titleStyle',
        property: 'TEXT'
      };
      styleClasses['oj-chart-yaxis-tick-label'] = {
        path: 'yAxis/tickLabel/style',
        property: 'TEXT'
      };
      ...
      styleClasses['oj-chart-y2axis-title'] = {
        path: 'y2Axis/titleStyle',
        property: 'TEXT'
      };
      styleClasses['oj-chart-reference-object-line'] = [{
        path: '_defaultReferenceObjectLineColor',
        property: 'color'
      }, {
        path: '_defaultReferenceObjectLineWidth',
        property: 'width'
      }];
      ...
      styleClasses['oj-legend'] = {
        path: 'legend/textStyle',
        property: 'TEXT'
      };
      styleClasses['oj-legend-title'] = {
        path: 'legend/titleStyle',
        property: 'TEXT'
      };
     ...
     */
    getDataItem: function getDataItem(seriesIndex, groupIndex) {
     ...
     * @ojsignature [{target: "Type", value: "{bounds: {x: number, y: number, width: number, height: number}}", for: "returns"}]
     */
    getPlotArea: function getPlotArea() {
     ...
     * @memberof oj.ojChart
     */
    getValuesAt: function getValuesAt(x, y) {
  ...
  oj.__registerWidget('oj.ojSparkChart', $.oj.dvtBaseComponent, {
    ...
    _GetChildStyleClasses: function _GetChildStyleClasses() {
      ...
      styleClasses['oj-dvtbase oj-sparkchart'] = {
     ...
     * @ojshortdesc Returns information for automation testing verification of a specified data item.
     */
    getDataItem: function getDataItem(itemIndex) {
      var ret = this._component.getAutomation().getDataItem(itemIndex); // : Provide backwards compatibility for getters until 1.2.0.
     ...
     * @protected
     */
    _AddAutomationGetters: function _AddAutomationGetters(map) {
      if (!map) {
        return;
     ...
     * @private
     */
    _addGetter: function _addGetter(map, key, props) {
      var prefix = key === 'selected' ? 'is' : 'get';
      var getterName = prefix + key.charAt(0).toUpperCase() + key.slice(1); // eslint-disable-next-line no-param-reassign
