 ...
 * @ignore
 */
define(['exports', 'ojs/ojcore-base', 'ojs/ojmessaging', 'ojs/ojpagingtabledatasource'], function (exports, oj$1, Message, ojpagingtabledatasource) {
  'use strict';
  ...
  var PagingCellSet = function PagingCellSet(cellSet, startIndex) {
  ...
  var PagingDataGridDataSource = function PagingDataGridDataSource(dataSource, options) {
    // Initialize
  ...
  oj$1._registerLegacyNamespaceProp('PagingDataGridDataSource', PagingDataGridDataSource); // Subclass from oj.DataSource


  oj$1.Object.createSubclass(PagingDataGridDataSource, oj$1.DataGridDataSource, 'oj.PagingDataGridDataSource');
  /**
  ...
  PagingDataGridDataSource.prototype.setPage = function (value, options) {
    ...
    try {
      PagingDataGridDataSource.superclass.handleEvent.call(this, oj$1.PagingModel.EventType.BEFOREPAGE, {
        page: value,
  ...
  PagingDataGridDataSource.prototype._handleChange = function (options) {
    ...
    switch (operation) {
      ...
      case 'insert':
        this.handleEvent(oj$1.PagingTableDataSource.EventType.ADD, {
  ...
  PagingDataGridDataSource.prototype.fetchHeaders = function (headerRange, callbacks, callbackObjects) {
  ...
  PagingDataGridDataSource.prototype._handleRowHeaderFetchSuccess = function (headerSet, headerRange, endHeaderSet) {
    var pagingHeaderSet;
  ...
  PagingDataGridDataSource.prototype._handleCellsFetchSuccess = function (cellSet, cellRanges) {
    ...
    var pagedCellSet = new oj$1.PagingCellSet(cellSet, this._startIndex); // clear callback before calling it because it may issue a refetch
  ...
  */
  ...
  PagingDataGridDataSource.prototype.move = function (rowToMove, referenceRow, position, callbacks, callbackObjects) {
  ...
  var PagingHeaderSet = function PagingHeaderSet(headerSet, startIndex) {
  ...
  exports.default = PagingDataGridDataSource$1;
