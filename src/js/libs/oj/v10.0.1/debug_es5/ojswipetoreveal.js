 ...
 * @ignore
 */
define(['exports', 'ojs/ojcore-base', 'jquery', 'ojs/ojcontext', 'ojs/ojoffcanvas', 'touchr'], function (exports, oj, $, Context, OffcanvasUtils, touchr) {
  'use strict';
  ...
  var SwipeToRevealUtils = {};

  oj._registerLegacyNamespaceProp('SwipeToRevealUtils', SwipeToRevealUtils); // mapping variable definition, used in a no-require environment. Maps the SwipeToRevealUtils object to the name used in the require callback.
  ...
  var setupSwipeActions = SwipeToRevealUtils.setupSwipeActions;
  var tearDownSwipeActions = SwipeToRevealUtils.tearDownSwipeActions;
