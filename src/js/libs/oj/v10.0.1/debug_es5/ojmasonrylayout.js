 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'jquery', 'ojs/ojcontext', 'ojs/ojconfig', 'ojs/ojthemeutils', 'ojs/ojcomponentcore', 'ojs/ojanimation', 'ojs/ojlogger', 'ojs/ojdomutils', 'ojs/ojfocusutils', 'ojdnd'], function (oj, $, Context, Config, ThemeUtils, Components, AnimationUtils, Logger, DomUtils, FocusUtils, ojdnd) {
  'use strict';
  ...
  */
   ...
   * See the Masonry Layout - Deferred Rendering demo for an example.</p>
   *
    ...
    oj.__registerWidget('oj.ojMasonryLayout', $.oj.baseComponent, {
      ...
      _handleDragEnter: function _handleDragEnter(event) {
        ...
        if (relatedTarget) {
          ...
          enteringMasonryLayout = elemUnderPoint && (elemUnderPoint === elem || DomUtils.isAncestor(elem, elemUnderPoint));
        }
      ...
      _handleDragLeave: function _handleDragLeave(event) {
        ...
        if (relatedTarget) {
          ...
          var elemUnderPoint = document.elementFromPoint(originalEvent.clientX, originalEvent.clientY);
          leavingMasonryLayout = elemUnderPoint && elemUnderPoint !== elem && !DomUtils.isAncestor(elem, elemUnderPoint);
        }
