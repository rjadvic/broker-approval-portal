...
define(['ojs/ojcore', 'ojs/ojdatasource-common'], function (oj) {
  "use strict"; // /////////// JsonDiagramDataSource //////////////////
    ...
    if (childData instanceof Promise) {
      ...
      childData.then(function (data) {
        ...
        if (Array.isArray(data.links)) {
          thisRef.data.links = Array.isArray(thisRef.data.links) ? thisRef.data.links.concat(data.links) : data.links;
        }
