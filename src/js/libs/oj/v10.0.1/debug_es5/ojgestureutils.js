 ...
 * @ignore
 */
define(['exports', 'jquery', 'ojs/ojdomutils'], function (exports, $, DomUtils) {
  'use strict';
  ...
  GestureUtils.stopDetectContextMenuGesture = function (rootNode) {
    if (rootNode._clickListener) {
      $(rootNode).off(GestureUtils._EVENT_NAMESPACE).removeClass('oj-menu-context-menu-launcher')[0].removeEventListener('click', rootNode._clickListener, true); // the other 2 contextMenu timeouts don't need to be cleared here
  ...
  var startDetectContextMenuGesture = GestureUtils.startDetectContextMenuGesture;
  var stopDetectContextMenuGesture = GestureUtils.stopDetectContextMenuGesture;
