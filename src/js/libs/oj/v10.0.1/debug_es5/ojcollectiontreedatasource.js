 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'ojs/ojdatasource-common', 'ojs/ojmodel'], function (oj, ojdatasourceCommon, Model) {
  'use strict';
  ...
  var CollectionNodeSet = function CollectionNodeSet(parentKey, collection, models, treeDataSource, start, count) {
  ...
  */
  ...
  var CollectionTreeDataSource = function CollectionTreeDataSource(options) {
  ...
  oj._registerLegacyNamespaceProp('CollectionTreeDataSource', CollectionTreeDataSource); // Default implementation
  ...
  CollectionTreeDataSource.prototype._createEvent = function (source, operation, index, parent, data) {
    return {
      source: source,
      operation: operation,
      index: index,
  ...
  CollectionTreeDataSource.prototype.FetchCollection = function (collectionObj, start, count, callbacks, parent) {
    var self = this;
  ...
  CollectionTreeDataSource.prototype._getNodeSet = function (collection, parent, start, count, models) {
  ...
  CollectionTreeDataSource.prototype._getModelForId = function (collection, start, count, key, depth) {
    var self = this;
    return new Promise(function (resolve) {
  ...
  CollectionTreeDataSource.prototype._fetch = function (collectionCacheObj, start, count, _success, error) {
    var self = this;
  ...
  CollectionTreeDataSource.prototype.move = function ( // eslint-disable-next-line no-unused-vars
