 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'jquery', 'ojs/ojcomponentcore', 'ojs/ojdvt-base', 'ojs/ojtimeaxis-toolkit', 'ojs/ojlocaledata', 'ojs/ojconverter-datetime', 'ojs/ojconverterutils-i18n', 'ojs/ojconverter-number'], function (oj, $, ojcomponentcore, ojdvtBase, ojtimeaxisToolkit, ojlocaledata, ojconverterDatetime, ConverterUtils, NumberConverter) {
  'use strict';
  ...
  oj.__registerWidget('oj.ojTimeAxis', $.oj.dvtBaseComponent, {
    ...
    _CreateDvtComponent: function _CreateDvtComponent(context, callback, callbackObj) {
      return ojtimeaxisToolkit.TimeAxis.newInstance(context, callback, callbackObj);
    },
    // @inheritdoc
    ...
    _LoadResources: function _LoadResources() {
      ...
      var hoursConverter = new ojconverterDatetime.IntlDateTimeConverter({
        hour: 'numeric'
      });
      ...
      var monthsConverter = new ojconverterDatetime.IntlDateTimeConverter({
        month: 'long'
      });
      var yearsConverter = new ojconverterDatetime.IntlDateTimeConverter({
        year: 'numeric'
      });
      var monthsConverterVert = new ojconverterDatetime.IntlDateTimeConverter({
        month: 'short'
      });
      var yearsConverterVert = new ojconverterDatetime.IntlDateTimeConverter({
        year: '2-digit'
      });
      var converter = {
