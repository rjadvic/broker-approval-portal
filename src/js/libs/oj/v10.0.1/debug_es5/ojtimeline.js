 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'jquery', 'ojs/ojcomponentcore', 'ojs/ojtime-base', 'ojs/ojkeyset', 'ojs/ojtimeline-toolkit', 'ojs/ojconverter-datetime'], function (oj, $, ojcomponentcore, ojtimeBase, ojkeyset, ojtimelineToolkit, ojconverterDatetime) {
  'use strict';
  ...
  var __oj_timeline_series_metadata = {
    "properties": {
      ...
      "itemLayout": {
        "type": "string",
        "enumValues": ["auto", "bottomToTop", "topToBottom"],
        "value": "auto"
      },
      "label": {
        "type": "string",
  ...
  */
  ...
  oj.__registerWidget('oj.ojTimeline', $.oj.dvtTimeComponent, {
    ...
    _CreateDvtComponent: function _CreateDvtComponent(context, callback, callbackObj) {
      return ojtimelineToolkit.Timeline.newInstance(context, callback, callbackObj);
    },
    ...
    _GetChildStyleClasses: function _GetChildStyleClasses() {
      ...
      styleClasses['oj-dvt-color-ramp'] = {
        path: 'styleDefaults/series/colors',
        property: 'COLOR'
      };
      return styleClasses;
    },
