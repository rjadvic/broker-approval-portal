 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'ojs/ojcomponentcore', 'jquery', 'ojs/ojdvt-base', 'ojs/ojdvt-treeview', 'ojs/ojkeyset', 'ojs/ojconfig'], function (oj, ojcomponentcore, $, ojdvtBase, ojdvtTreeview, ojkeyset, Config) {
  'use strict';
  ...
  */
    ...
    "properties": {
      ...
      "nodeDefaults": {
        ...
        "properties": {
          ...
          "labelDisplay": {
            "type": "string",
            "enumValues": ["auto", "horizontal", "off", "rotated"],
            "value": "auto"
          },
          "labelHalign": {
            "type": "string",
  ...
  oj.__registerWidget('oj.ojSunburst', $.oj.dvtBaseComponent, {
    ...
    options: {
       ...
       * The DataProvider can either have an arbitrary data shape, in which case an <oj-sunburst-node> element must be specified in the itemTemplate slot or it can have [oj.ojSunburst.Node]{@link oj.ojSunburst#Node} as its data shape, in which case no template is required.
       * @expose
       * @name data
       ...
       * @ojwriteback
       */
      expanded: new ojkeyset.AllKeySetImpl(),
    ...
    _CreateDvtComponent: function _CreateDvtComponent(context, callback, callbackObj) {
      return ojdvtTreeview.Sunburst.newInstance(context, callback, callbackObj);
    },
    //* * @inheritdoc */
    ...
    _ProcessOptions: function _ProcessOptions() {
      ...
      if (!this.options.expanded) {
        this.options.expanded = new ojkeyset.AllKeySetImpl();
      }
