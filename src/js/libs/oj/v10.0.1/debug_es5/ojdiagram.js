 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'ojs/ojcomponentcore', 'ojs/ojdvt-base', 'ojs/ojdiagram-utils', 'jquery', 'ojs/ojdiagram-toolkit', 'ojs/ojlogger', 'ojs/ojkeyset', 'ojs/ojdatasource-common'], function (oj, Components, DvtAttributeUtils, DiagramUtils, $, ojdiagramToolkit, Logger, ojkeyset, ojdatasourceCommon) {
  'use strict';
  ...
  (function () {
    var __oj_diagram_metadata = {
      "properties": {
        ...
        "nodeHighlightMode": {
          "type": "string",
          "enumValues": ["node", "nodeAndIncomingLinks", "nodeAndLinks", "nodeAndOutgoingLinks"],
          "value": "node"
        },
        "nodeProperties": {
          "type": "function"
        ...
        "panning": {
          "type": "string",
          "enumValues": ["auto", "centerContent", "fixed", "none"],
          "value": "none"
        },
        "promotedLinkBehavior": {
          "type": "string",
          "enumValues": ["full", "lazy", "none"],
          "value": "lazy"
        },
        "renderer": {
          "type": "function"
          ...
          "properties": {
            ...
            "linkDefaults": {
              ...
              "properties": {
                ...
                "endConnectorType": {
                  "type": "string",
                  "enumValues": ["arrow", "arrowConcave", "arrowOpen", "circle", "none", "rectangle", "rectangleRounded"],
                  "value": "none"
                },
                "labelStyle": {
                  "type": "object"
  ...
  var __oj_diagram_node_metadata = {
    "properties": {
      ...
      "descendantsConnectivity": {
        "type": "string",
        "enumValues": ["connected", "disjoint", "unknown"],
        "value": "unknown"
      },
      "icon": {
        "type": "object",
  ...
  oj._registerLegacyNamespaceProp('DiagramUtils', DiagramUtils); // bleed DiagramUtils into oj to keep backward compatibility
  ...
  var ConversionDiagramDataSource = function ConversionDiagramDataSource(data, options) {
    this.childDataCallback = options ? options.childData : null;
    ConversionDiagramDataSource.superclass.constructor.call(this, data);
  };

  oj._registerLegacyNamespaceProp('ConversionDiagramDataSource', ConversionDiagramDataSource); // Subclass from oj.DiagramDataSource


  oj.Object.createSubclass(ConversionDiagramDataSource, oj.DiagramDataSource, 'oj.ConversionDiagramDataSource');
  /**
  ...
  oj.__registerWidget('oj.ojDiagram', $.oj.dvtBaseComponent, {
    ...
    _GetChildStyleClasses: function _GetChildStyleClasses() {
      ...
      styleClasses['oj-diagram-node'] = [{
        path: 'styleDefaults/nodeDefaults/icon/color',
        property: 'fill'
      }];
