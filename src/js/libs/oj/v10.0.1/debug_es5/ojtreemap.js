 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'ojs/ojcomponentcore', 'jquery', 'ojs/ojdvt-base', 'ojs/ojdvt-treeview', 'ojs/ojkeyset'], function (oj, ojcomponentcore, $, ojdvtBase, ojdvtTreeview, ojkeyset) {
  'use strict';
  ...
  (function () {
    ...
    oj.CustomElementBridge.register('oj-treemap', {
      metadata: __oj_treemap_metadata
    });
  })();
  ...
  var __oj_treemap_node_metadata = {
    "properties": {
      ...
      "pattern": {
        "type": "string",
        "enumValues": ["largeChecker", "largeCrosshatch", "largeDiagonalLeft", "largeDiagonalRight", "largeDiamond", "largeTriangle", "none", "smallChecker", "smallCrosshatch", "smallDiagonalLeft", "smallDiagonalRight", "smallDiamond", "smallTriangle"],
        "value": "none"
      },
      "selectable": {
        "type": "string",
  ...
  oj.__registerWidget('oj.ojTreemap', $.oj.dvtBaseComponent, {
    ...
    options: {
      ...
      /**
       * The DataProvider for the nodes of the treemap. It should provide a data tree where each node in the data tree corresponds to a node in the treemap.
       ...
       * The DataProvider can either have an arbitrary data shape, in which case an <oj-treemap-node> element must be specified in the nodeTemplate slot or it can have [oj.oj.ojTreemap.Node]{@link oj.ojTreemap#Node} as its data shape, in which case no template is required.
       * @expose
       * @name data
    ...
    _CreateDvtComponent: function _CreateDvtComponent(context, callback, callbackObj) {
      return ojdvtTreeview.Treemap.newInstance(context, callback, callbackObj);
    },
    //* * @inheritdoc */
    _GetSimpleDataProviderConfigs: function _GetSimpleDataProviderConfigs() {
      return {
        data: {
          ...
          expandedKeySet: new ojkeyset.AllKeySetImpl()
        }
      };
    },
    //* * @inheritdoc */
    ...
    _GetChildStyleClasses: function _GetChildStyleClasses() {
      ...
      styleClasses['oj-treemap-node-header'] = [{
        path: 'nodeDefaults/header/backgroundColor',
      ...
      styleClasses['oj-treemap-node-header oj-hover'] = [{
        path: 'nodeDefaults/header/hoverBackgroundColor',
        property: 'background-color'
      }, {
        path: 'nodeDefaults/header/hoverOuterColor',
        property: 'border-top-color'
      }, {
        path: 'nodeDefaults/header/hoverInnerColor',
        property: 'border-bottom-color'
      }, {
        path: 'nodeDefaults/header/_hoverLabelStyle',
        property: 'TEXT'
      }];
      styleClasses['oj-treemap-node-header oj-selected'] = [{
        ...
        path: 'nodeDefaults/header/selectedOuterColor',
        property: 'border-top-color'
      }, {
        path: 'nodeDefaults/header/selectedInnerColor',
        property: 'border-bottom-color'
      }, {
        path: 'nodeDefaults/header/_selectedLabelStyle',
        property: 'TEXT'
      }];
      return styleClasses;
    },
  ...
  */
   ...
   * @ojmaxitems 1
   * @memberof oj.ojTreemap
   * @ojtemplateslotprops oj.ojTreemap.NodeTemplateContext
   * @ojpreferredcontent ["TreemapNodeElement"]
   *
   ...
   * @ojtemplateslotprops oj.ojTreemap.NodeContentContext
   * @memberof oj.ojTreemap
   *
   ...
   * @ojtemplateslotprops oj.ojTreemap.TooltipContext
   * @memberof oj.ojTreemap
   *
