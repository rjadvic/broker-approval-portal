 ...
 * @ignore
 */
define(['exports', 'ojs/ojdvt-toolkit'], function (exports, dvt) {
  'use strict';
  /**
   * @license
   * Copyright (c) 2014, 2021, Oracle and/or its affiliates.
  ...
  var DvtOverviewDefaults = function DvtOverviewDefaults() {
    this.Init({
      'alta': DvtOverviewDefaults.VERSION_1
    });
  };
  ...
  var DvtOverviewEventManager = function DvtOverviewEventManager(overview) {
  ...
  DvtOverviewEventManager.prototype._onMouseDragEnd = function (event) {
    this._overview.endDragPan(); // Clear the stage absolute position cache
  ...
  DvtOverviewEventManager.prototype._onTouchDragEnd = function (event) {
    ...
    dvt.EventManager.consumeEvent(event); // Clear the stage absolute position cache
  ...
  var OverviewParser = function OverviewParser(view) {
    this.Init(view);
  };

  dvt.Obj.createSubclass(OverviewParser, dvt.Obj);
  /**
   * Initializes the component parser.
   * @param {Overview} view The Overview instance.
   */

  OverviewParser.prototype.Init = function (view) {
    this._view = view;
  };
  /**
  ...
  OverviewParser.prototype.parse = function (data) {
  ...
  OverviewParser.prototype.ParseRootAttributes = function (options) {
    // The object that will be populated with parsed values and returned
    var ret = new Object(); // animation related options
    ...
    if (options['currentTime'] != null) ret.currentTime = options['currentTime'];
  ...
  OverviewParser.prototype.calculateWidth = function (startTime, endTime, viewportStartTime, viewportEndTime, viewportEndPos) {
  ...
  DvtOverviewStyleUtils.getHandleFillColor = function (options) {
    if (options['_hfc'] != null) return options['_hfc'];else return options['style']['handleFillColor'];
  };
  /**
  ...
  DvtOverviewStyleUtils.getBorderTopColor = function (options) {
    if (options['_btc'] != null) return options['_btc'];else return options['style']['borderTopColor'];
  };
  /**
  ...
  DvtOverviewStyleUtils.getBorderTopStyle = function (options) {
    if (options['_bts'] != null) return options['_bts'];else return options['style']['borderTopStyle'];
  };
  /**
  ...
  DvtOverviewStyleUtils.getWindowBackgroundColor = function (options) {
    if (options['_wbc'] != null) return options['_wbc'];else return options['style']['windowBackgroundColor'];
  };
  /**
  ...
  DvtOverviewStyleUtils.getWindowBorderTopStyle = function (options) {
    if (options['_wbts'] != null) return options['_wbts'];else return options['style']['windowBorderTopStyle'];
  };
  /**
  ...
  DvtOverviewStyleUtils.getWindowBorderRightStyle = function (options) {
    if (options['_wbrs'] != null) return options['_wbrs'];else return options['style']['windowBorderRightStyle'];
  };
  /**
  ...
  DvtOverviewStyleUtils.getWindowBorderBottomStyle = function (options) {
    if (options['_wbbs'] != null) return options['_wbbs'];else return options['style']['windowBorderBottomStyle'];
  };
  /**
  ...
  DvtOverviewStyleUtils.getWindowBorderLeftStyle = function (options) {
    if (options['_wbls'] != null) return options['_wbls'];else return options['style']['windowBorderLeftStyle'];
  };
  /**
  ...
  DvtOverviewStyleUtils.getWindowBorderTopColor = function (options) {
    if (options['_wbtc'] != null) return options['_wbtc'];else return options['style']['windowBorderTopColor'];
  };
  /**
  ...
  DvtOverviewStyleUtils.getWindowBorderRightColor = function (options) {
    if (options['_wbrc'] != null) return options['_wbrc'];else return options['style']['windowBorderRightColor'];
  };
  /**
  ...
  DvtOverviewStyleUtils.getWindowBorderBottomColor = function (options) {
    if (options['_wbbc'] != null) return options['_wbbc'];else return options['style']['windowBorderBottomColor'];
  };
  /**
  ...
  DvtOverviewStyleUtils.getWindowBorderLeftColor = function (options) {
    if (options['_wblc'] != null) return options['_wblc'];else return options['style']['windowBorderLeftColor'];
  };
  /**
  ...
  DvtOverviewStyleUtils.getOverviewBackgroundColor = function (options) {
    if (options['_obc'] != null) return options['_obc'];else return options['style']['overviewBackgroundColor'];
  };
  /**
  ...
  DvtOverviewStyleUtils.getCurrentTimeIndicatorColor = function (options) {
    if (options['_ctic'] != null) return options['_ctic'];else return options['style']['currentTimeIndicatorColor'];
  };
  /**
  ...
  DvtOverviewStyleUtils.getTimeAxisBarColor = function (options) {
    if (options['_tabc'] != null) return options['_tabc'];else return options['style']['timeAxisBarColor'];
  };
  /**
  ...
  DvtOverviewStyleUtils.getTimeAxisBarAlpha = function (options) {
    if (options['_tabo'] != null) return options['_tabo'];else return options['style']['timeAxisBarAlpha'];
  };
  /**
  ...
  DvtOverviewStyleUtils.getTimeIndicatorColor = function (options) {
    if (options['_tic'] != null) return options['_tic'];else return options['style']['timeIndicatorColor'];
  };
  /**
  ...
  var OverviewUtils = new Object();

  OverviewUtils.supportsTouch = function () {
    return dvt.Agent.isTouchDevice();
  };

  dvt.Obj.createSubclass(OverviewUtils, dvt.Obj);
  /**
  ...
  OverviewUtils.getDatePosition = function (startTime, endTime, time, width) {
  ...
  DvtOverviewRenderer.renderOverview = function (overview) {
    ...
    DvtOverviewRenderer._updateCurrentTime(overview); // render data


    overview.renderData(overview.Width, overview.Height);

    if (interactive) {
      DvtOverviewRenderer._createBorderAroundSlidingWindow(overview); // updates the position and width of sliding window and borders around window
  ...
  DvtOverviewRenderer._renderBackground = function (overview) {
    ...
    background.setSolidFill(overview._overviewBackgroundColor); // Do not antialias the background
  ...
  DvtOverviewRenderer._renderSlidingWindow = function (overview) {
    ...
    var height = overview.Height; // draw sliding window first so that it is under the markers

    var slidingWindow = new dvt.Rect(overview.getCtx(), 0, 0, width, height, 'window');
    slidingWindow.setSolidFill(overview._windowBackgroundColor, overview._windowBackgroundAlpha); // Do not antialias the Timeline Overview
    ...
    if (!overview.isFeatureOff('zoom')) {
      ...
      if (overview.isVerticalScrollingEnabled()) {
        ...
        var topHandleCmds = dvt.PathUtils.moveTo(0, 0) + dvt.PathUtils.quadTo(3, 6, 8, 8) + dvt.PathUtils.lineTo(28, 8) + dvt.PathUtils.quadTo(33, 6, 36, 0);
        dvt.PathUtils.closePath();
        var bottomHandleCmds = dvt.PathUtils.moveTo(0, 0) + dvt.PathUtils.quadTo(3, -6, 8, -8) + dvt.PathUtils.lineTo(28, -8) + dvt.PathUtils.quadTo(33, -6, 36, 0);
        dvt.PathUtils.closePath();
        ...
        bottomHandleBackground.setSolidFill(overview._windowBackgroundColor, 0); // Do not antialias the handle backgrounds
        ...
        bottomHandle.setSolidStroke(overview._handleFillColor); // if the handle color is the same as the background color, it should not have antialiasing so it does not appear visible
      ...
      if (overview.isHorizontalScrollingEnabled()) {
        ...
        var leftHandleCmds = dvt.PathUtils.moveTo(0, 0) + dvt.PathUtils.quadTo(6, 3, 8, 8) + dvt.PathUtils.lineTo(8, 28) + dvt.PathUtils.quadTo(6, 33, 0, 36);
        dvt.PathUtils.closePath();
        var rightHandleCmds = dvt.PathUtils.moveTo(0, 0) + dvt.PathUtils.quadTo(-6, 3, -8, 8) + dvt.PathUtils.lineTo(-8, 28) + dvt.PathUtils.quadTo(-6, 33, 0, 36);
        dvt.PathUtils.closePath();
        ...
        rightHandleBackground.setSolidFill(overview._windowBackgroundColor, 0); // Do not antialias the handle backgrounds
        ...
        rightHandle.setSolidStroke(overview._handleFillColor); // if the handle color is the same as the background color, it should not have antialiasing so it does not appear visible
  ...
  DvtOverviewRenderer._createBorderAroundSlidingWindow = function (overview) {
    var width = overview.Width;
    var height = overview.Height; // add the left and right grip last since we want them over the markers
    ...
    if (overview.isVertical()) {
      ...
      var rightHandle = new dvt.Line(overview.getCtx(), left, bottomCenter, width, bottomCenter, 'rh'); // leftTopBar and rightTopBar are only visible in fusion skins
      ...
      rightHandle = new dvt.Line(overview.getCtx(), rightCenter, top, rightCenter, bottom, 'rh'); // leftTopBar and rightTopBar are only visible in fusion skins
    ...
    if (overview._windowBorderLeftStyle != 'none') leftHandle.setSolidStroke(overview._windowBorderLeftColor);
    overview.addChild(leftHandle);
    overview._leftHandle = leftHandle;
    if (overview._windowBorderRightStyle != 'none') rightHandle.setSolidStroke(overview._windowBorderRightColor);
    ...
    if (overview._windowBorderBottomStyle != 'none') bottomBar.setSolidStroke(overview._windowBorderBottomColor);
    overview.addChild(bottomBar);
    if (overview._windowBorderTopStyle != 'none') topBar.setSolidStroke(overview._windowBorderTopColor);
  ...
  DvtOverviewRenderer._updateSlidingWindow = function (overview) {
    ...
    var width = overview.Width;
    var height = overview.Height; // find the position relative to the width of timeline overview
    ...
    if (overview.isHorizontalScrollingEnabled()) {
      ...
      if (overview.isRTL()) overview.setSlidingWindowPosX(window, width - x2Pos);else overview.setSlidingWindowPosX(window, x1Pos);
  ...
  DvtOverviewRenderer._setSlidingWindowWidth = function (overview, slidingWindow, width) {
    ...
    slidingWindow.setWidth(width); // update left and right filter if one is specified
    ...
    if (overview.isLeftAndRightFilterRendered()) {
      ...
      rightBackground.setWidth(Math.max(0, overview.Width - rightStart)); // updates the background resize handle for touch
    ...
    if (overview.isFeatureOff('zoom')) return; // update the resize handles
  ...
  DvtOverviewRenderer._setSlidingWindowHeight = function (overview, slidingWindow, height) {
    ...
    slidingWindow.setHeight(height); // if resize feature is off then there's nothing else to do
  ...
  DvtOverviewRenderer._renderTimeAxisTopBar = function (overview) {
    var width = overview.Width;
    var height = overview.Height; // border above time axis

    if (overview.isVertical()) {
      if (overview.isRTL()) var timeAxisTopBar = new dvt.Line(overview.getCtx(), overview.getTimeAxisWidth(), 0, overview.getTimeAxisWidth(), height, 'tab');else timeAxisTopBar = new dvt.Line(overview.getCtx(), width - overview.getTimeAxisWidth(), 0, width - overview.getTimeAxisWidth(), height, 'tab');
    } else {
      if (overview.isOverviewAbove()) timeAxisTopBar = new dvt.Line(overview.getCtx(), 0, overview.getTimeAxisHeight(), width, overview.getTimeAxisHeight(), 'tab');else timeAxisTopBar = new dvt.Line(overview.getCtx(), 0, height - overview.getTimeAxisHeight(), width, height - overview.getTimeAxisHeight(), 'tab');
    }

    timeAxisTopBar.setSolidStroke(overview._timeAxisBarColor, overview._timeAxisBarOpacity); // Do not antialias the time axis top bar
  ...
  DvtOverviewRenderer._renderLeftAndRightFilters = function (overview, handleStart) {
    ...
    if (overview.isLeftAndRightFilterRendered()) {
      ...
      overview.addChild(rightBackground); // the left and right background resize handle are needed for touch because the touch area for resize handle goes
  ...
  DvtOverviewRenderer._renderTimeAxis = function (overview) {
    ...
    for (var i = 0; i < overview._ticks.length; i++) {
      ...
      if (vertical) var time_pos = overview.getDateYPosition(time);else time_pos = overview.getDateXPosition(time);
      var label = child['label'];
      var maxWidth = 0;

      if (i + 1 < overview._ticks.length) {
        var next_time = parseInt(overview._ticks[i + 1]['time'], 10);
        if (vertical) var next_time_pos = overview.getDateYPosition(next_time);else next_time_pos = overview.getDateXPosition(next_time);
  ...
  DvtOverviewRenderer._addTick = function (overview, pos, width, height, id) {
    if (overview.isVertical()) var line = new dvt.Line(overview.getCtx(), 0, pos, width, pos, id);else line = new dvt.Line(overview.getCtx(), pos, 0, pos, height, id);
    var stroke = new dvt.Stroke(overview._timeIndicatorColor, 1, 1, false, {
      dashArray: '3'
    });
    line.setStroke(stroke); // Do not antialias tick marks
  ...
  DvtOverviewRenderer._addLabel = function (overview, pos, text, height, maxWidth, id, labelStyle) {
    if (overview.isVertical()) {
      ...
      if (overview.isOverviewAbove()) var y = 2;else y = height - overview.getTimeAxisHeight() + 2;
    ...
    dvt.TextUtils.fitText(label, maxWidth, Infinity, overview); // save the raw text for tooltip
  ...
  DvtOverviewRenderer._parseFilledTimeRanges = function (overview) {
    if (overview._formattedTimeRanges == null) return; // draw filled time ranges so that it is over the sliding window but under the markers
  ...
  DvtOverviewRenderer._addFilledTimeRange = function (overview, elem, width, height) {
    ...
    if (rangeStart != null && rangeEnd != null) {
      ...
      if (overview.isVertical()) var displayable = new dvt.Rect(overview.getCtx(), 0, rangeStart_pos, width - overview.getTimeAxisWidth(), rangeWidth, 'ftr');else displayable = new dvt.Rect(overview.getCtx(), rangeStart_pos, overview.isOverviewAbove() ? overview.getTimeAxisHeight() : 0, rangeWidth, height - overview.getTimeAxisHeight(), 'ftr');
      if (color != null) displayable.setSolidFill(color, 0.4);
      displayable.setCursor('move'); // Do not antialias filled time range
  ...
  DvtOverviewRenderer._updateCurrentTime = function (overview) {
    var width = overview.Width;
    var height = overview.Height; // return if current time is invalid or outside of the time range

    if (overview._currentTime == null || isNaN(overview._currentTime) || overview._currentTime < overview._xMin || overview._currentTime > overview._xMax) return;
    ...
    line.setSolidStroke(overview._currentTimeIndicatorColor); // Do not antialias current time line
  ...
  var Overview = function Overview(context, callback, callbackObj) {
    this.Init(context, callback, callbackObj);
  };

  dvt.Obj.createSubclass(Overview, dvt.Container);
  Overview.MIN_WINDOW_SIZE = 10;
  Overview.DEFAULT_VERTICAL_TIMEAXIS_SIZE = 40;
  Overview.DEFAULT_HORIZONTAL_TIMEAXIS_SIZE = 20;
  Overview.HANDLE_PADDING_SIZE = 20;
  /**
  ...
  Overview.prototype.Init = function (context, callback, callbackObj) {
    Overview.superclass.Init.call(this, context); // Create the defaults object
    ...
    if (interactive) {
      ...
      this.EventManager.addListeners(this); // register listeners
  ...
  Overview.prototype.initDefaults = function () {
  ...
  Overview.prototype.setViewportRange = function (x1, x2, y1, y2) {
    if (x1 != null && x2 != null) {
      var x1Pos = this.getDateXPosition(x1);
      var x2Pos = this.getDateXPosition(x2); // make sure it's in bounds
      ...
      if (x2Pos > x1Pos) {
        ...
        if (this.isRTL()) this.setSlidingWindowPosX(slidingWindow, this.Width - (x1Pos + width));else this.setSlidingWindowPosX(slidingWindow, x1Pos);
    ...
    if (y1 != null && y2 != null) {
      ...
      var y2Pos = this.getDateYPosition(y2); // make sure it's in bounds
  ...
  Overview.prototype.isFeatureOff = function (feature) {
  ...
  Overview.prototype.render = function (obj, width, height) {
    // Store the size
    ...
    if (obj == null) {
      var slidingWindow = this.getSlidingWindow(); // sets the correct time where the sliding window starts
      ...
      this.SetOptions(obj); // If new data options are provided, parse it and apply the properties
  ...
  Overview.prototype.SetOptions = function (options) {
    // Combine the user options with the defaults and store
    this.Options = this.Defaults.calcOptions(options);
  };

  Overview.prototype.getParser = function (obj) {
    return new OverviewParser(this);
  };

  Overview.prototype.Parse = function (obj) {
  ...
  Overview.prototype._applyParsedProperties = function (props) {
    ...
    this._animationOnClick = props.animationOnClick; // chart specific options: left and right margin
    ...
    if (props.minimumWindowSize != null && props.minimumWindowSize > 0) this._minimumWindowSize = props.minimumWindowSize;
    ...
    this._timeAxisBarOpacity = DvtOverviewStyleUtils.getTimeAxisBarAlpha(this.Options); // chart specific options: left and right filter panels
  ...
  Overview.prototype.getDateXPosition = function (date) {
  ...
  Overview.prototype.getDateYPosition = function (date) {
  ...
  Overview.prototype.getXPositionDate = function (pos) {
  ...
  Overview.prototype.getYPositionDate = function (pos) {
  ...
  Overview.prototype.isHorizontalRTL = function () {
  ...
  Overview.prototype.setMargins = function (leftMargin, rightMargin) {
    if (!isNaN(leftMargin) && leftMargin != null && leftMargin > 0) this._leftMargin = leftMargin;
    if (!isNaN(rightMargin) && rightMargin != null && rightMargin > 0) this._rightMargin = rightMargin;
  }; // returns the width of the overview, taking margins into account


  Overview.prototype.getOverviewSize = function () {
    if (this.isVertical()) return this.Height - this._leftMargin - this._rightMargin;else return this.Width - this._leftMargin - this._rightMargin;
  }; // returns the width of the overview, taking margins into account


  Overview.prototype.getOverviewWidth = function () {
    return this.Width - this._leftMargin - this._rightMargin;
  }; // returns the width of the overview, taking margins into account


  Overview.prototype.getOverviewHeight = function () {
    return this.Height;
  }; // return the minmum X position where the sliding window can reach


  Overview.prototype.getMinimumPositionX = function () {
    return this._leftMargin;
  }; // return the minmum Y position where the sliding window can reach


  Overview.prototype.getMinimumPositionY = function () {
    return 0;
  }; // return the maximum X position where the sliding window can reach


  Overview.prototype.getMaximumPositionX = function () {
    return this.Width - this._rightMargin;
  }; // return the maximum Y position where the sliding window can reach


  Overview.prototype.getMaximumPositionY = function () {
    return this.Height;
  }; // returns the minimum width of the sliding window


  Overview.prototype.getMinimumWindowWidth = function () {
    if (this._minWinSize != null) return this._minWinSize;else if (this._minimumWindowSize != null) {
    ...
    } else return Overview.MIN_WINDOW_SIZE;
  }; // returns the minimum height of the sliding window


  Overview.prototype.getMinimumWindowHeight = function () {
    if (this._minWinSize != null) return this._minWinSize;else if (this._minimumWindowSize != null) {
  ...
  Overview.prototype.getMaximumWindowWidth = function () {
    return this.Width;
  };

  Overview.prototype.getMaximumWindowHeight = function () {
    return this.Height;
  };

  Overview.prototype.getGrippySize = function () {
    return 10;
  }; // return the start of the resize handle


  Overview.prototype.getHandleStart = function () {
    if (OverviewUtils.supportsTouch()) return this.getHandleSize() / 2;else return 0;
  }; // return the size of the resize handle, which is wider on touch devices


  Overview.prototype.getHandleSize = function () {
    if (OverviewUtils.supportsTouch()) return 30;else return 10;
  };

  Overview.prototype.isHandle = function (drawable) {
    var id = drawable.getId();
    return id == 'lh' || id == 'rh' || id == 'lhb' || id == 'rhb' || id == 'th' || id == 'bh' || id == 'thb' || id == 'bhb' || id == 'hgrpy' || id == 'vgrpy' || id == 'lbgrh' || id == 'rbgrh' || drawable.getParent() != null && (drawable.getParent().getId() == 'hgrpy' || drawable.getParent().getId() == 'vgrpy');
  };

  Overview.prototype.isLeftOrRightHandle = function (drawable) {
    var id = drawable.getId();
    return id == 'lh' || id == 'rh' || id == 'lhb' || id == 'rhb' || id == 'hgrpy' || id == 'lbgrh' || id == 'rbgrh' || drawable.getParent() != null && drawable.getParent().getId() == 'hgrpy';
  };

  Overview.prototype.isTopOrBottomHandle = function (drawable) {
    var id = drawable.getId();
    return id == 'th' || id == 'bh' || id == 'thb' || id == 'bhb' || id == 'vgrpy' || drawable.getParent() != null && drawable.getParent().getId() == 'vgrpy';
  }; // for vertical


  Overview.prototype.getTimeAxisWidth = function () {
    // checks if there is a time axis
    if (this._timeAxisInfo == null) return 0; // read from skin?

    if (this._timeAxisWidth == null) {
      var width = parseInt(this._timeAxisInfo.width, 10);
      if (!isNaN(width) && width < this.Width) this._timeAxisWidth = width;else this._timeAxisWidth = Overview.DEFAULT_VERTICAL_TIMEAXIS_SIZE;
    }

    return this._timeAxisWidth;
  };

  Overview.prototype.getTimeAxisHeight = function () {
    // checks if there is a time axis
    if (this._timeAxisInfo == null) return 0; // read from skin?

    if (this._timeAxisHeight == null) {
      var height = parseInt(this._timeAxisInfo.height, 10);
      if (!isNaN(height) && height < this.Height) this._timeAxisHeight = height;else this._timeAxisHeight = Overview.DEFAULT_HORIZONTAL_TIMEAXIS_SIZE;
    }

    return this._timeAxisHeight;
  };

  Overview.prototype.getPageX = function (event) {
    if (OverviewUtils.supportsTouch() && event.targetTouches != null) {
      if (event.targetTouches.length > 0) return event.targetTouches[0].pageX;else return null;
    } else return event.pageX;
  };

  Overview.prototype.getPageY = function (event) {
    if (OverviewUtils.supportsTouch() && event.targetTouches != null) {
      if (event.targetTouches.length > 0) return event.targetTouches[0].pageY;else return null;
  ...
  Overview.prototype.isBackgroundRendered = function () {
    return true;
  };
  /**
  ...
  Overview.prototype.isLeftAndRightFilterRendered = function () {
    return false;
  };

  Overview.prototype.getSlidingWindow = function () {
    return this.getChildAt(1);
  };

  Overview.prototype.getSlidingWindowWidth = function () {
  ...
  Overview.prototype.getSlidingWindowHeight = function () {
  ...
  Overview.prototype.getLeftBackground = function () {
    if (this.isLeftAndRightFilterRendered()) return this.getChildAt(3);else return null;
  };

  Overview.prototype.getRightBackground = function () {
    if (this.isLeftAndRightFilterRendered()) return this.getChildAt(4);else return null;
  };

  Overview.prototype.getLeftBackgroundHandle = function () {
    if (this.isLeftAndRightFilterRendered() && !this.isFeatureOff('zoom')) return this.getChildAt(5);else return null;
  };

  Overview.prototype.getRightBackgroundHandle = function () {
    if (this.isLeftAndRightFilterRendered() && !this.isFeatureOff('zoom')) return this.getChildAt(6);else return null;
  };

  Overview.prototype.getLeftHandle = function () {
    return this._leftHandle;
  };

  Overview.prototype.getRightHandle = function () {
    return this._rightHandle;
  };

  Overview.prototype.getLeftTopBar = function () {
    var offset = this._lastChildIndex - 2;
    return this.getChildAt(this.getNumChildren() - offset);
  };

  Overview.prototype.getRightTopBar = function () {
    var offset = this._lastChildIndex - 3;
    return this.getChildAt(this.getNumChildren() - offset);
  };

  Overview.prototype.getBottomBar = function () {
    var offset = this._lastChildIndex - 4;
    return this.getChildAt(this.getNumChildren() - offset);
  };

  Overview.prototype.getTopBar = function () {
    var offset = this._lastChildIndex - 5;
    return this.getChildAt(this.getNumChildren() - offset);
  };

  Overview.prototype.setLinePos = function (line, pos1, pos2) {
    if (this.isVertical()) {
  ...
  Overview.prototype.getLinePos1 = function (line) {
    if (this.isVertical()) return line.getY1();else return line.getX1();
  };
  /**
  ...
  Overview.prototype._findDrawable = function (event) {
    ...
    if (target != null) {
      ...
      } else if (id.substr(0, 4) != 'tick' && id != 'ltb' && id != 'rtb' && id != 'bb' && id != 'tab') return target;
    }
  ...
  Overview.prototype.isMovable = function (drawable) {
    if (drawable.getId() == 'window' || drawable.getId() == 'ftr' || drawable.getId() == 'sta' || this.isHandle(drawable)) return true;
    return false;
  };
  ...
  Overview.prototype.setRectPos = function (rect, pos) {
    if (this.isVertical()) rect.setY(pos);else rect.setX(pos);
  };

  Overview.prototype.getRectPos = function (rect) {
    if (this.isVertical()) return rect.getY();else return rect.getX();
  };

  Overview.prototype.getRectSize = function (rect) {
    if (this.isVertical()) return rect.getHeight();else return rect.getWidth();
  };

  Overview.prototype.setRectSize = function (rect, size) {
    if (this.isVertical()) rect.setHeight(size);else rect.setWidth(size);
  };

  Overview.prototype.getSlidingWindowPos = function (slidingWindow) {
    if (this.isVertical()) return slidingWindow.getTranslateY();else return slidingWindow.getTranslateX();
  };

  Overview.prototype.getSlidingWindowPosX = function (slidingWindow) {
    return slidingWindow.getTranslateX();
  };

  Overview.prototype.getSlidingWindowPosY = function (slidingWindow) {
    return slidingWindow.getTranslateY();
  };

  Overview.prototype.setSlidingWindowPosX = function (slidingWindow, xPos) {
    ...
    if (this.isLeftAndRightFilterRendered()) {
      ...
      rightBackground.setX(rightStart);
      rightBackground.setWidth(Math.max(0, this.Width - rightStart)); // updates the background resize handle for touch
  ...
  Overview.prototype.setSlidingWindowPosY = function (slidingWindow, yPos) {
    yPos = Math.max(this.getMinimumPositionY(), yPos);
    slidingWindow.setTranslateY(yPos);
  };

  Overview.prototype.getSlidingWindowSize = function (slidingWindow) {
    return this.getRectSize(slidingWindow);
  };

  Overview.prototype.renderData = function (width, height) {};
  /************************** sliding window animation *********************************************/


  Overview.prototype.animateSlidingWindow = function (newX, newY) {
    var slidingWindow = this.getSlidingWindow(); // first check if sliding window moved or resized at all

    if ((newX == undefined || newX == this.getSlidingWindowPosX(slidingWindow)) && (newY == undefined || newY == this.getSlidingWindowPosY(slidingWindow))) return;
    ...
    if (this.isVerticalScrollingEnabled() && newY != null) {
      ...
      var topBarY2Setter = topBar.setY2; // make sure it doesn't go over
      ...
      if (!this.isVertical()) {
        ...
        this.animateProperty(animator, rightHandle, rightHandleY2Getter, rightHandleY2Setter, newY + slidingWindowHeight); // top and bottom borders
        ...
        this.animateProperty(animator, topBar, topBarY1Getter, topBarY1Setter, newY);
        this.animateProperty(animator, bottomBar, bottomBarY2Getter, bottomBarY2Setter, newY + slidingWindowHeight);
        this.animateProperty(animator, topBar, topBarY2Getter, topBarY2Setter, newY + slidingWindowHeight); // left and right top bar
    ...
    if (this.isHorizontalScrollingEnabled() && newX != null) {
      ...
      var topBarX2Setter = topBar.setX2; // make sure it doesn't go over
      ...
      this.animateProperty(animator, slidingWindow, posXGetter, posXSetter, newX); // left and right handles
      ...
      this.animateProperty(animator, rightHandle, rightHandleX2Getter, rightHandleX2Setter, newX + slidingWindowWidth); // left and right top bar
  ...
  Overview.prototype.animateProperty = function (animator, obj, getter, setter, value) {
    if (animator != null) animator.addProp(dvt.Animator.TYPE_NUMBER, obj, getter, setter, value);else setter.call(obj, value);
  };
  ...
  Overview.prototype.HandleShapeMouseOver = function (event) {
    var drawable = this._findDrawable(event); // Return if no drawable is found


    if (!drawable || drawable.getId() == 'bg' || drawable.getId() == 'ocd') return; // if it is a label, show a tooltip of the label if it is truncated

    if (drawable.getId().substr(0, 5) == 'label' && (drawable instanceof dvt.OutputText || drawable instanceof dvt.BackgroundOutputText)) {
      if (drawable.isTruncated()) this.getCtx().getTooltipManager().showDatatip(event.pageX, event.pageY, drawable._rawText, '#000000');
      return;
    }

    if (drawable.getId() == 'window' || drawable.getId() == 'ftr' || drawable.getId() == 'arr' || this.isHandle(drawable)) return;
    return drawable;
  };

  Overview.prototype.HandleShapeMouseOut = function (event) {
  ...
  Overview.prototype.HandleShapeClick = function (event, pageX, pageY) {
    ...
    if (!drawable || drawable.getId() == 'window' || this.isHandle(drawable)) return; // if clicking anywhere on the overview scroll to the location
    ...
    if (drawable.getId() == 'bg' || drawable.getId().substr(0, 5) == 'label' || drawable.getId() == 'ocd' || drawable.getId() == 'lbg' || drawable.getId() == 'rbg') {
      ...
      relPos = this.stageToLocal(relPos); // scroll sliding window
      ...
      if (this.isHorizontalScrollingEnabled()) {
        ...
        if (this.isRTL()) posX = width - posX;
      }

      this.animateSlidingWindow(newPosX, newPosY); // scroll timeline

      var newX1, newX2, newY1, newY2;

      if (newPosX != null) {
        var slidingWindowWidth = slidingWindow.getWidth(); // make sure position is in bound
      ...
      if (newPosY != null) {
        var slidingWindowHeight = slidingWindow.getHeight(); // make sure position is in bound
  ...
  Overview.prototype.beginDragPan = function (event, compX, compY) {
    var drawable = this._findDrawable(event);

    if (drawable != null && this.isMovable(drawable)) {
      // if the drawable is the formatted time ranges, move the sliding window
      if (drawable.getId() == 'ftr' || drawable.getId() == 'sta') drawable = this.getSlidingWindow();
      this._initX = compX;
      this._initY = compY;

      if (this.isHandle(drawable)) {
        var slidingWindow = this.getSlidingWindow();
        if (drawable.getParent().getId() == 'hgrpy' || drawable.getParent().getId() == 'vgrpy') drawable = drawable.getParent();
        ...
        if (drawableId == 'rbgrh') drawable = slidingWindow.getChildAt(slidingWindow.getNumChildren() - 3);
        ...
        if (this.isLeftOrRightHandle(drawable)) {
          ...
          if (!OverviewUtils.supportsTouch()) {
            drawable.setX(0 - Overview.HANDLE_PADDING_SIZE);
            drawable.setWidth((drawable.getWidth() + Overview.HANDLE_PADDING_SIZE) * 2);
          }
        } else {
          this._isHorizontalResize = false;
          this._oldStartPosY = slidingWindow.getY();
          this._oldEndPosY = this._oldStartPosY + slidingWindow.getHeight(); // drawable should be lhb or rhb
          // temporarily increase size of handle to capture wider area and prevent cursor from changing
          // only do this for non touch since we won't run into cursor issue

          if (!OverviewUtils.supportsTouch()) {
            drawable.setY(0 - Overview.HANDLE_PADDING_SIZE);
            drawable.setHeight((drawable.getHeight() + Overview.HANDLE_PADDING_SIZE) * 2);
          }
      ...
      this._moveDrawable = drawable; // ask the overview peer to notify us if the release happened outside of the overview
  ...
  Overview.prototype.overrideCursors = function (cursor) {
    var slidingWindow = this.getSlidingWindow();
  ...
  Overview.prototype.resetCursors = function () {
    var slidingWindow = this.getSlidingWindow();
  ...
  Overview.prototype.endDragPan = function () {
    if (this._moveDrawable != null && this._isDragPanning == true) {
      if (this._moveDrawable.getId() == 'window') this.handleWindowDrag('scrollEnd');else if (this.isHandle(this._moveDrawable)) {
        this.finishHandleDrag(0, 0); // reset the temporarily resized handle
  ...
  Overview.prototype.contDragPan = function (event, compX, compY) {
    if (this._moveDrawable != null && this._initX != -1) {
      ...
      this._initX = compX;
      this._initY = compY;
      if (this._moveDrawable.getId() == 'window') this.handleWindowDrag('scrollPos', diffX, diffY);else if (this._moveDrawable.getId() == 'lh' || this._moveDrawable.getId() == 'lhb') this.handleLeftOrRightHandleDragPositioning(event, diffX, true);else if (this._moveDrawable.getId() == 'rh' || this._moveDrawable.getId() == 'rhb') this.handleLeftOrRightHandleDragPositioning(event, diffX, false);else if (this._moveDrawable.getId() == 'th' || this._moveDrawable.getId() == 'thb') this.handleTopOrBottomHandleDragPositioning(event, diffY, true);else if (this._moveDrawable.getId() == 'bh' || this._moveDrawable.getId() == 'bhb') this.handleTopOrBottomHandleDragPositioning(event, diffY, false);
    }
  };

  Overview.prototype.HandleTouchStart = function (event) {
    var touches = event.touches;
    this._touchStartX = touches[0].pageX;
    this._touchStartY = touches[0].pageY; // see if this is a width change gesture
    ...
    if (touches.length == 2) {
      ...
      if (Math.abs(this._touchStartY - this._touchStartY2) < 20) this._counter = 0;else {
  ...
  Overview.prototype.HandleTouchMove = function (event) {
    event.preventDefault();
    var touches = event.touches; // width change gesture
    ...
    if (this._touchStartX2 != null && this._touchStartY2 != null) {
      ...
      this._touchStartX2 = touches[1].pageX; // reset

      this._counter = 0;
    } else {
      var pageDx = Math.abs(this._touchStartX - touches[0].pageX);
      var pageDy = Math.abs(this._touchStartY - touches[0].pageY); // null out the var to signal that this is not a click event
  ...
  Overview.prototype.HandleTouchEnd = function (event) {
    if (this._touchStartX2 != null && this._touchStartY2 != null) {
      // width change gesture
      this.finishHandleDrag(0, 0);
    } else {
      if (this._touchStartX != null && this._touchStartY != null) this.HandleShapeClick(event, this._touchStartX, this._touchStartY);
    }
  ...
  Overview.prototype.stopDragAction = function () {
    this.endDragPan();
  };
  /************************** end event handling *********************************************/
  ...
  Overview.prototype.handleWindowDrag = function (type, deltaX, deltaY) {
    var slidingWindow = this.getSlidingWindow();
  ...
  Overview.prototype.fireScrollEvent = function (type, newX1, newX2, newY1, newY2) {
    // scroll timeline
    var nx1, nx2, ny1, ny2;
  ...
  Overview.prototype.handleLeftOrRightHandleDragPositioning = function (event, delta, isLeft) {
    ...
    if (isLeft) {
      ...
      if (windowWidth - delta <= this.getMinimumWindowWidth()) return; // make sure position of left handle is not less than minimum (delta is negative when moving handle to the left)

      if (windowPos + delta <= this.getMinimumPositionX()) return; // window should only resize when the cursor is back to where the handle is

      var relPos = this.getCtx().pageToStageCoords(this.getPageX(event), this.getPageY(event)).x;
      relPos = this.stageToLocal(relPos);
      if (delta > 0 && relPos <= windowPos) return;else if (delta < 0 && relPos >= windowPos) return;
      ...
      // make sure width of sliding window is larger than minimum
      if (windowWidth + delta <= this.getMinimumWindowWidth()) return; // make sure position of right handle is not less than minimum

      if (windowPos + windowWidth + delta >= this.getMaximumPositionX()) return; // window should only resize when the cursor is back to where the handle is

      relPos = this.getCtx().pageToStageCoords(this.getPageX(event), this.getPageY(event)).x;
      relPos = this.stageToLocal(relPos);
      if (delta > 0 && relPos <= windowPos + windowWidth) return;else if (delta < 0 && relPos >= windowPos + windowWidth) return;

      DvtOverviewRenderer._setSlidingWindowWidth(this, slidingWindow, windowWidth + delta);
    } // sync with time axis


    DvtOverviewRenderer._updateBorderAroundSlidingWindow(this); // tell event handler that time range is changing
  ...
  Overview.prototype.handleTopOrBottomHandleDragPositioning = function (event, delta, isTop) {
    ...
    if (isTop) {
      // make sure width of sliding window is larger than minimum
      if (windowHeight - delta <= this.getMinimumWindowHeight()) return; // make sure position of top handle is not less than minimum (delta is negative when moving handle to the top)

      if (windowPos + delta <= this.getMinimumPositionY()) return; // window should only resize when the cursor is back to where the handle is
      ...
      // make sure width of sliding window is larger than minimum
      if (windowHeight + delta <= this.getMinimumWindowHeight()) return; // make sure position of bottom handle is not less than minimum

      if (windowPos + windowHeight + delta >= this.getMaximumPositionY()) return; // window should only resize when the cursor is back to where the handle is

      relPos = this.getCtx().pageToStageCoords(this.getPageX(event), this.getPageY(event)).y;
      relPos = this.stageToLocal(relPos);
      if (delta > 0 && relPos <= windowPos + windowHeight) return;else if (delta < 0 && relPos >= windowPos + windowHeight) return;
  ...
  Overview.prototype.isHorizontalScrollingEnabled = function () {
  ...
  Overview.prototype.isVerticalScrollingEnabled = function () {
  ...
  Overview.prototype.isRangeChangingSupported = function () {
    return true;
  };

  Overview.prototype.finishHandleDrag = function (deltaX, deltaY) {
    var slidingWindow = this.getSlidingWindow();
    var evt;
  ...
  Overview.prototype.dispatchEvent = function (event) {
  ...
  Overview.prototype.destroy = function () {
    ...
    Overview.superclass.destroy.call(this);
  };
