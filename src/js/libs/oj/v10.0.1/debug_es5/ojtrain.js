 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'jquery', 'ojs/ojcontext', 'ojs/ojthemeutils', 'ojs/ojcomponentcore'], function (oj, $, Context, ThemeUtils, ojcomponentcore) {
  'use strict';
        ...
        if (selectedButton && selectedStepMessageType == null) {
          ...
          if (selectedAnimationDuration > 0) {
            var selectedButtonAnimationResolve = selectedButtonBusyContext.addBusyState({
              description: "The train selected button index='" + this._selectedIndex + "' is animating."
            });
            setTimeout(function () {
        ...
        if (visitedButton && previousStepMessageType == null) {
          ...
          if (visitedAnimationDuration > 0) {
            var visitedButtonAnimationResolve = visitedButtonBusyContext.addBusyState({
              description: "The train visited button index='" + this._previousStepIndex + "' is animating."
            });
            setTimeout(function () {
        ...
        if (previousStepIcon) {
          ...
          if (iconAnimationDuration > 0) {
            var iconAnimationResolve = iconBusyContext.addBusyState({
              description: "The train icon index='" + this._previousStepIndex + "' is animating."
            });
            setTimeout(function () {
        ...
        if (selectedStepIcon) {
          ...
          if (selectedIconAnimationDuration > 0) {
            var selectedIconAnimationResolve = selectedIconBusyContext.addBusyState({
              description: "The train icon index='" + this._selectedIndex + "' is animating."
            });
            setTimeout(function () {
