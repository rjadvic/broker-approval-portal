...
define(['ojs/ojcore-base', 'jquery', 'ojs/ojcontext', 'ojs/ojbutton', 'ojs/ojeditablevalue', 'ojs/ojcomponentcore', 'ojs/ojdomutils', 'ojs/ojthemeutils', 'ojs/ojlogger', 'ojs/ojvalidator-numberrange', 'ojs/ojconverter-number'], function (oj$1, $, ojcontext, ojbutton, ojeditablevalue, Components, DomUtils, ThemeUtils, Logger, NumberRangeValidator, ojconverterNumber) {
  ...
  (function () {
    ...
    * @memberof! oj.ojInputNumber
    ...
    oj$1.__registerWidget('oj.ojInputNumber', $.oj.editableValue, {
      version: '1.0.0',
      ...
      */
      ...
      _SetLoading: function _SetLoading() {
        ...
        var readOnly = true;
        this.element[0].readOnly = readOnly; // removes role spinbutton while loading
      ...
      _createOjButtonset: function _createOjButtonset() {
        ...
        var defaultOptions = ThemeUtils.parseJSONFromFontFamily('oj-input-number-option-defaults') || {};
        var buttonChromingDefault = defaultOptions.buttonChroming || 'solid';
      ...
      _repeat: function _repeat(i, direction, event, spinning) {
        ...
        if (!spinning) {
          ...
          busyContext = oj$1.Context.getContext(domElem).getBusyContext();
      ...
      _adjustValueForFractions: function _adjustValueForFractions(value, step, minOpt, maxOpt, stepOpt, precision, initialValue) {
        ...
        oj$1.Assert.assert(precision > 0);
