 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'ojs/ojcomponentcore', 'ojs/ojdvt-base', 'jquery', 'ojs/ojnbox-toolkit'], function (oj, ojcomponentcore, DvtAttributeUtils, $, ojnboxToolkit) {
  'use strict';
  ...
  var __oj_n_box_metadata = {
    "properties": {
      ...
      "groupAttributes": {
        "type": "Array<string>",
        "enumValues": ["color", "indicatorColor", "indicatorIconColor", "indicatorIconPattern", "indicatorIconShape"],
    ...
    "properties": {
      ...
      "icon": {
        ...
        "properties": {
          ...
          "pattern": {
            "type": "string",
            "enumValues": ["largeChecker", "largeCrosshatch", "largeDiagonalLeft", "largeDiagonalRight", "largeDiamond", "largeTriangle", "mallChecker", "none", "smallCrosshatch", "smallDiagonalLeft", "smallDiagonalRight", "smallDiamond", "smallTriangle"],
            "value": "none"
          },
          "shape": {
            "type": "string"
  ...
  oj.__registerWidget('oj.ojNBox', $.oj.dvtBaseComponent, {
     ...
     * @instance
     */
    getRowsTitle: function getRowsTitle() {
      var auto = this._component.getAutomation();
     ...
     * @instance
     */
    getRow: function getRow(rowValue) {
      var auto = this._component.getAutomation();
     ...
     * @instance
     */
    getColumnsTitle: function getColumnsTitle() {
      var auto = this._component.getAutomation();
     ...
     * @instance
     */
    getColumn: function getColumn(columnValue) {
      var auto = this._component.getAutomation();
     ...
     * @instance
     */
    getCell: function getCell(rowValue, columnValue) {
      var auto = this._component.getAutomation();
     ...
     * @instance
     */
    getGroupBehavior: function getGroupBehavior() {
      var auto = this._component.getAutomation();
     ...
     * @instance
     */
    getGroupNode: function getGroupNode(groupCategory) {
      var auto = this._component.getAutomation();
    ...
    getContextByNode: function getContextByNode(node) {
      ...
      if (context && context.subId !== 'oj-nbox-tooltip' && context.subId !== 'oj-nbox-dialog-close-button' && context.subId !== 'oj-nbox-overflow') {
        return context;
      }
    ...
    _GetComponentDeferredDataPaths: function _GetComponentDeferredDataPaths() {
      return {
        root: ['cells', 'rows', 'columns', 'nodes', 'data']
      };
    },
    //* * @inheritdoc */
