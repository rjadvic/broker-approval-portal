 ...
 * @ignore
 */
define(['exports', 'ojs/ojcore-base', 'ojs/ojcore'], function (exports, oj$1, oj$2) {
  'use strict';
  ...
  var DataGridDataSource = function DataGridDataSource(data) {
  ...
  var DiagramDataSource = function DiagramDataSource(data) {
  ...
  */
  ...
  var TableDataSource = function TableDataSource(data, options) {
  ...
  */
  ...
  var TreeDataSource = function TreeDataSource(data) {
