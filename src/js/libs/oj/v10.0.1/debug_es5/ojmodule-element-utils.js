 ...
 * @ignore
 */
define(['exports', 'ojs/ojcore-base', 'ojs/ojhtmlutils'], function (exports, oj, HtmlUtils) {
  'use strict';
  ...
  ModuleElementUtils.createViewModel = function (options) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      if (viewModel && (options.initialize === 'always' || options.params != null && options.initialize !== 'never')) {
  ...
  ModuleElementUtils.createConfig = function (options) {
    ...
    return Promise.all([ModuleElementUtils.createView({
      viewPath: viewPath,
  ...
  var createView = ModuleElementUtils.createView;
  var createViewModel = ModuleElementUtils.createViewModel;
  var createConfig = ModuleElementUtils.createConfig;
