 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'jquery', 'knockout', 'ojs/ojdatasource-common'], function (oj, jquery, ko, ojdatasourceCommon) {
  'use strict';
  ...
  var ArrayPagingDataSource = function ArrayPagingDataSource(data) {
    this.data = data; // Start at the beginning
  ...
  oj._registerLegacyNamespaceProp('ArrayPagingDataSource', ArrayPagingDataSource); // Subclass from oj.DataSource
  ...
  ArrayPagingDataSource.prototype._refreshDataWindow = function (options) {
    ...
    options = options || {}; // Reinit the array

    this.dataWindow = new Array(this._getSize()); // Copy from the source data
