 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'jquery', 'ojs/ojcomponentcore', 'ojs/ojtime-base', 'ojs/ojgantt-toolkit', 'ojs/ojkeyset', 'ojs/ojlogger', 'ojs/ojconverter-datetime', 'ojs/ojconverter-number', 'ojs/ojthemeutils'], function (oj, $, ojcomponentcore, ojtimeBase, ojganttToolkit, ojkeyset, Logger, ojconverterDatetime, ojconverterNumber, ThemeUtils) {
  'use strict';
      ...
      "properties": {
        ...
        "majorAxis": {
          ...
          "properties": {
            ...
            "scale": {
              "type": "string",
              "enumValues": ["days", "hours", "minutes", "months", "quarters", "seconds", "weeks", "years"]
            },
            "zoomOrder": {
              "type": "Array<string>"
            }
        ...
        "taskDefaults": {
          ...
          "properties": {
            ...
            "labelPosition": {
              ...
              "enumValues": ["end", "innerCenter", "innerEnd", "innerStart", "none", "start"],
            ...
            "overlap": {
              ...
              "properties": {
                "behavior": {
                  "type": "string",
                  "enumValues": ["auto", "overlay", "stack", "stagger"],
                  "value": "auto"
                },
                "offset": {
                  "type": "number"
            ...
            "type": {
              "type": "string",
              "enumValues": ["auto", "milestone", "normal", "summary"],
              "value": "auto"
            }
          }
        },
  ...
  var __oj_gantt_dependency_metadata = {
    "properties": {
      ...
      "type": {
        "type": "string",
        "enumValues": ["finishFinish", "finishStart", "startFinish", "startStart"],
        "value": "finishStart"
      }
    },
    "extension": {}
   ...
   * @property {("area"|"line")=} [type="line"] The type of reference object being shown. If the value is set to "area", use the start and end properties of the reference object. Otherwise, use the value property.
   * @property {string=} start The start time value of this reference object. See <a href="#formats-section">Date and Time Formats</a> for more details on required string formats, and see type for more details.
   * @property {string=} end The end time value of this reference object. See <a href="#formats-section">Date and Time Formats</a> for more details on required string formats, and see type for more details.
   ...
   * @property {Object|null} itemData The data provider row data object for the hovered task. This will only be set if a DataProvider for <a href="#taskData">task-data</a> is being used.
   ...
   * @property {Array.<Object>|null} itemData An array of the data provider row data objects associated with the tasks belonging to the gantt row. This will only be set if a DataProvider for <a href="#taskData">task-data</a> is being used.
   * @property {Element} componentElement The gantt element.
  ...
  oj.__registerWidget('oj.ojGantt', $.oj.dvtTimeComponent, {
    ...
    options: {
      ...
      minorAxis: {
        ...
        converter: {
          default: null,
          seconds: new ojconverterDatetime.IntlDateTimeConverter({
            hour: 'numeric',
            minute: '2-digit',
            second: '2-digit'
          }),
          minutes: new ojconverterDatetime.IntlDateTimeConverter({
            hour: 'numeric',
            minute: '2-digit'
          }),
          hours: new ojconverterDatetime.IntlDateTimeConverter({
            hour: 'numeric'
          }),
          days: new ojconverterDatetime.IntlDateTimeConverter({
            month: 'numeric',
            day: '2-digit'
          }),
          weeks: new ojconverterDatetime.IntlDateTimeConverter({
            month: 'numeric',
            day: '2-digit'
          }),
          months: new ojconverterDatetime.IntlDateTimeConverter({
            month: 'long'
          }),
          quarters: new ojconverterDatetime.IntlDateTimeConverter({
            month: 'long'
          }),
          years: new ojconverterDatetime.IntlDateTimeConverter({
            year: 'numeric'
          })
        },
       ...
       * @property {Object|null} taskContexts.itemData The data provider row data object for the source task. This will only be set if a DataProvider for <a href="#taskData">task-data</a> is being used.
    ...
    _getComponentStyleMap: function _getComponentStyleMap() {
      ...
      map.taskUnprogress = 'oj-gantt-task-progress-container';
      map.tooltipLabel = 'oj-dvt-datatip-label';
      map.tooltipValue = 'oj-dvt-datatip-value';
      map.tooltipTable = 'oj-dvt-datatip-table';
      map.referenceObjectInnerLine = 'oj-gantt-reference-object-inner-line';
      map.referenceObjectLine = 'oj-gantt-reference-object-line';
      map.referenceObjectArea = 'oj-gantt-reference-object-area';
    ...
    _LoadResources: function _LoadResources() {
      ...
      resources.zoomOut = 'oj-fwk-icon oj-fwk-icon-minus'; // expand/collapse icon images
      // Add images

      var rtl = this._GetReadingDirection() === 'rtl';
      resources.closed = "oj-fwk-icon oj-fwk-icon-arrow-".concat(rtl ? 'w' : 'e');
      resources.open = "oj-fwk-icon oj-fwk-icon-arrow-".concat(rtl ? 'sw' : 'se'); // progress value converter for task tooltip

      resources.percentConverter = new ojconverterNumber.IntlNumberConverter({
        style: 'percent'
      });
    },
    // @inheritdoc
