 ...
 * @ignore
 */
define(['exports', 'ojs/ojcore-base', 'ojs/ojdatasource-common'], function (exports, oj$1, ojdatasourceCommon) {
  'use strict';
  ...
  */
  ...
  var ArrayCellSet = function ArrayCellSet(startRow, endRow, startColumn, endColumn, callback) {
  ...
  */
  ...
  var ArrayDataGridDataSource = function ArrayDataGridDataSource(data, options) {
  ...
  oj$1._registerLegacyNamespaceProp('ArrayDataGridDataSource', ArrayDataGridDataSource); // Subclass from oj.DataGridDataSource
  ...
  ArrayDataGridDataSource.prototype.fetchHeaders = function (headerRange, callbacks, callbackObjects) {
  ...
  */
  ...
  ArrayDataGridDataSource.prototype.move = function ( // eslint-disable-next-line no-unused-vars
  ...
  */
  ...
  ArrayDataGridDataSource.prototype._getModelEvent = function (operation, rowKey, columnKey, rowIndex, columnIndex, silent) {
    var event = {};
    event.source = this;
  ...
  var ArrayHeaderSet = function ArrayHeaderSet(start, end, axis, callback) {
    this.m_start = start;
    this.m_end = end;
    this.m_axis = axis;
    this.m_callback = callback;
