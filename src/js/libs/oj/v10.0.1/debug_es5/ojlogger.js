...
define(['exports'], function (exports) {
  ...
  var log = Logger.log;
  var option = Logger.option;
  var LEVEL_ERROR = Logger.LEVEL_ERROR;
  var LEVEL_INFO = Logger.LEVEL_INFO;
  var LEVEL_LOG = Logger.LEVEL_LOG;
  var LEVEL_NONE = Logger.LEVEL_NONE;
  var LEVEL_WARN = Logger.LEVEL_WARN;
