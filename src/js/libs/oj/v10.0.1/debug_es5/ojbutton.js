  ...
  (function () {
    ...
    oj.__registerWidget('oj.ojButton', $.oj.baseComponent, {
      ...
      _processSlots: function _processSlots() {
        ...
        var rootSlots = ojcustomelementUtils.CustomElementUtils.getSlotMap(rootElem); // don't add context menu here since we do not ever need to move it
        ...
        var slots = ojcustomelementUtils.CustomElementUtils.getSlotMap(elem); // rearrange slots
      ...
      _initButtonTypes2: function _initButtonTypes2() {
        ...
        if (this._isToggle) {
          ...
          this.rootElement = this.element[0]; // oj-button-jqui was renamed to oj-button-toggle
      ...
      _destroy: function _destroy() {
        ...
        if (!isToggle) {
          _removeClasses(this.rootElement, BASE_CLASSES + ' oj-button-toggle ' + STATE_CLASSES + ' ' + TYPE_CLASSES + ' ' + CHROMING_CLASSES);
        }
      ...
      _setOption: function _setOption(key, value, flags) {
        ...
        switch (key) {
          ...
          case 'disabled':
            ...
            this._updateEffectivelyDisabled(); // Legacy code for widgets.  Toolbar custom element will listen for property change event on buttons.
    ...
    oj.__registerWidget('oj.ojButtonset', $.oj.baseComponent, {
      ...
      _setOption: function _setOption(key, value, flags) {
        ...
        if (key === 'disabled') {
          ...
          this._refreshTabStop(); // Legacy code for widgets.  Toolbar custom element will listen for property change event on buttons.
      ...
      _setup: function _setup(isCreate) {
        ...
        this._labelledByUpdatedForSet(elem.id, null, this.options.labelledBy, this.element); // set describedby on the element as aria-describedby
