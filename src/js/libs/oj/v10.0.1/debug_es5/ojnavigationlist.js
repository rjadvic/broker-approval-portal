 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'ojs/ojcomponentcore', 'ojs/ojthemeutils', 'jquery', 'ojs/ojdomutils', 'ojs/ojnavigationlistdnd', 'ojs/ojlistview', 'ojs/ojdatacollection-common', 'ojs/ojmenu', 'ojs/ojbutton'], function (oj$1, Components, ThemeUtils, $, DomUtils, ojnavigationlistdnd, ojlistview, DataCollectionUtils, ojmenu, ojbutton) {
  'use strict';
  ...
  var _ojNavigationListView = _NavigationListUtils.clazz(oj$1._ojListView,
  /** @lends _ojNavigationListView.prototype */
  {
    ...
    GetDnDContext: function GetDnDContext() {
      if (typeof ojnavigationlistdnd.NavigationListDndContext !== 'undefined' && this.ojContext.element[0].tagName.toLowerCase() === this.TAG_NAME_TAB_BAR) {
    ...
    _initListHandler: function _initListHandler() {
      ...
      if (drillMode === this.OPTION_DRILL_MODE_SLIDING) {
        this.m_listHandler = new oj$1.SlidingNavListHandler(this, this.ojContext.element, this.ojContext);
      } else if (drillMode === this.OPTION_DRILL_MODE_COLLAPSIBLE) {
        this.m_listHandler = new oj$1.CollapsibleNavListHandler(this, this.ojContext.element, this.ojContext);
      } else if (drillMode === this.OPTION_DRILL_MODE_NONE && (edge === this.OPTION_EDGE_TOP || edge === this.OPTION_EDGE_BOTTOM)) {
        this.m_listHandler = new oj$1.HorizontalNavListHandler(this, this.ojContext.element, this.ojContext);
      } else {
        this.m_listHandler = new oj$1.DefaultNavListHandler(this, this.ojContext.element, this.ojContext);
      }
    ...
    getItemBadgeStyleClass: function getItemBadgeStyleClass() {
    ...
    compareValues: function compareValues(value1, value2) {
      return value1 === value2 || oj$1.Object.compareValues(value1, value2);
    },
  ...
  (function () {
     ...
     * when items are added or removed from the array.  See the documentation for <a href="ArrayDataProvider.html">oj.ArrayDataProvider</a> for more details on the available options.</p>
     *
    ...
    */
    ...
    oj$1.__registerWidget('oj.ojNavigationList', $.oj.baseComponent, {
      ...
      options: {
         ...
         */
        expanded: new oj$1._ojListViewExpandedKeySet(),
      ...
      */
      ...
      _CompareOptionValues: function _CompareOptionValues(option, value1, value2) {
        switch (option) {
          case 'currentItem':
          case 'selection':
            return oj$1.Object.compareValues(value1, value2);
  ...
  */
  ...
  var DefaultNavListHandler = function DefaultNavListHandler(widget, root, component) {
  ...
  DefaultNavListHandler.prototype.HandleExpandAndCollapseKeys = // eslint-disable-next-line no-unused-vars
  ...
  DefaultNavListHandler.prototype.SetOptions = function (options) {// DO Nothing
  };
  /**
   * Handler for blur event
   * @param {Event} event the blur event
  ...
  var CollapsibleNavListHandler = function CollapsibleNavListHandler(widget, root, component) {
    CollapsibleNavListHandler.superclass.constructor.call(this, widget, root, component);
  }; // Subclass from oj.Object


  oj$1.Object.createSubclass(CollapsibleNavListHandler, DefaultNavListHandler, 'oj.CollapsibleNavListHandler');

  oj$1._registerLegacyNamespaceProp('CollapsibleNavListHandler', CollapsibleNavListHandler);
  ...
  CollapsibleNavListHandler.prototype.HandleExpandAndCollapseKeys = function (event, keyCode, current, currentItemKey) {
  ...
  var HorizontalNavListHandler = function HorizontalNavListHandler(widget, root, component) {
  ...
  oj$1.Object.createSubclass(HorizontalNavListHandler, DefaultNavListHandler, 'oj.HorizontalNavListHandler');

  oj$1._registerLegacyNamespaceProp('HorizontalNavListHandler', HorizontalNavListHandler);
  ...
  var _HorizontalNavListOverflowHandler = function _HorizontalNavListOverflowHandler(items, overflow, truncation, navlistHandler) {
  ...
  HorizontalNavListHandler.prototype._handleOverflow = function (overflow, truncation) {
    ...
    var overflowHandler = new _HorizontalNavListOverflowHandler(items, overflow, truncation, this); // Return if there is no truncation or overflow handling needed
  ...
  HorizontalNavListHandler.prototype._getOverflowMenuButton = function () {
    if (!this.m_overflowMenuItem) {
      ...
      anchorElement.attr('role', 'button').attr('aria-haspopup', 'true').attr('aria-pressed', 'false').attr('tabindex', '-1').attr('href', '#').append(iconElement) // @HTMLUpdateOK constructed by component and not using string passed through any API
  ...
  _HorizontalNavListOverflowHandler.prototype.applyTruncation = function () {
    ...
    var itemEdge = item[0].getBoundingClientRect()[DomUtils.getReadingDirection() === 'ltr' ? 'right' : 'left'];
  ...
  _HorizontalNavListOverflowHandler.prototype._isOverflowed = function (containerEdge, itemEdge, overflowItemWidth) {
  ...
  var SlidingNavListHandler = function SlidingNavListHandler(widget, root, component) {
    SlidingNavListHandler.superclass.constructor.call(this, widget, root, component); // this keeps a stack of expanded items in top to bottom order

    this.m_expanded = [];
  }; // Subclass from oj.Object


  oj$1.Object.createSubclass(SlidingNavListHandler, CollapsibleNavListHandler, 'oj.SlidingNavListHandler');

  oj$1._registerLegacyNamespaceProp('SlidingNavListHandler', SlidingNavListHandler);
  ...
  SlidingNavListHandler.prototype._slideAnimation = function (item, isMovingNext, focusableElement, event, animationResolve) {
    var self = this;
  ...
  SlidingNavListHandler.prototype._slideAnimationComplete = function (item, isMovingNext, focusableElement, event, needFocusAncestor) {
  ...
  SlidingNavListHandler.prototype._showOrHideHierarchyMenu = function (hierarchyMenuDisplayThresholdLevel) {
    var itemsinTree = this._hviewMenu.find('li').length;
