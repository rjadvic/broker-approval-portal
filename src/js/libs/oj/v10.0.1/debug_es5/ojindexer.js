 ...
 * @ignore
 */
define(['exports', 'ojs/ojcore-base', 'ojs/ojtranslation', 'jquery', 'hammerjs', 'ojs/ojcontext', 'ojs/ojjquery-hammer', 'ojs/ojcomponentcore', 'ojs/ojdomutils'], function (exports, oj, Translations, $, Hammer, Context, ojjqueryHammer, ojcomponentcore, DomUtils) {
  'use strict';
  ...
  var IndexerModel = function IndexerModel() {};

  oj._registerLegacyNamespaceProp('IndexerModel', IndexerModel); // without the at-name tag, JSDoc tool prepends a "." to the field name for some reason, which messes up the QuickNav.
  ...
  var ListViewIndexerModel = function ListViewIndexerModel(listview) {
    this.listview = listview;
    this.Init();
  };

  oj._registerLegacyNamespaceProp('ListViewIndexerModel', ListViewIndexerModel); // Subclass from oj.EventSource
