 ...
 * @ignore
 */
define(['ojs/ojcore', 'jquery', 'ojs/ojtranslation', 'ojs/ojmessaging', 'ojs/ojlocaledata', 'ojs/ojlogger', 'ojs/ojconverterutils-i18n', 'ojs/ojconverter', 'ojs/ojvalidator', 'ojs/ojvalidationfactory-base', 'ojs/ojconverter-color', 'ojs/ojvalidator-length', 'ojs/ojvalidator-regexp', 'ojs/ojvalidator-required', 'ojs/ojvalidation-error', 'ojs/ojvalidator-async'], function (oj, $, Translations, Message, LocaleData, Logger, __ConverterI18nUtils, Converter, Validator, __ValidationFactoryBase, ColorConverter, LengthValidator, RegExpValidator, RequiredValidator) {
  "use strict";
