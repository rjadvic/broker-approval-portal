 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'ojs/ojlogger', 'ojs/ojcontext', 'ojs/ojconfig', 'ojs/ojresponsiveutils', 'ojs/ojthemeutils', 'ojs/ojtimerutils', 'ojs/ojtranslation'], function (oj, Logger, Context, Config, ResponsiveUtils, ThemeUtils, TimerUtils, Translations) {
  'use strict';
