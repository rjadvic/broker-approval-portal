 ...
 * @ignore
 */
define(['ojs/ojcore', 'ojs/ojcomponentcore', 'ojs/ojslider', 'jqueryui-amd/widgets/draggable', 'ojs/ojtouchproxy', 'ojs/ojeditablevalue', 'ojs/ojcore-base', 'jquery', 'ojs/ojcolor', 'ojs/ojdomutils', 'ojs/ojlogger', 'ojs/ojlabelledbyutils'], function (ojcore, ojcomponentcore, ojslider, draggable, ojtouchproxy, ojeditablevalue, oj, $, Color, DomUtils, Logger, LabeledByUtils) { 'use strict';
    ...
    oj.__registerWidget('oj.ojColorSpectrum', $.oj.editableValue,
      {
          ...
          if (!ret) {
            switch (subId) {
              ...
              case 'oj-hue-slider-bar' :
                ret = this._$hueSlider.ojSlider('getNodeBySubId', { subId: 'oj-slider-bar' });
                break;
              case 'oj-hue-slider-bar-value' :
                ret = this._$hueSlider.ojSlider('getNodeBySubId', { subId: 'oj-slider-bar-value' });
                break;
              case 'oj-hue-slider-thumb' :
                ret = this._$hueSlider.ojSlider('getNodeBySubId', { subId: 'oj-slider-thumb-0' });
                break;
              case 'oj-opacity-slider-bar' :
                ret = this._$alphaSlider.ojSlider('getNodeBySubId', { subId: 'oj-slider-bar' });
                break;
              case 'oj-opacity-slider-bar-value' :
                ret = this._$alphaSlider.ojSlider('getNodeBySubId', { subId: 'oj-slider-bar-value' });
                break;
              case 'oj-opacity-slider-thumb' :
                ret = this._$alphaSlider.ojSlider('getNodeBySubId', { subId: 'oj-slider-thumb-0' });
                break;
              default:
                break;
            }
        ...
        _AfterCreate: function () {
          ...
          if (label) {
            ...
            if (!labelId) {
              Logger.warn('JET Color Spectrum: The label for this component needs an id in order ' +
                             'to be accessible');
            } else {
        ...
        _SetRawValue: function (val, event) {
          ...
          if (typeof val === 'string') {
            try {
              ...
              Logger.error("ojColorSpectrum (id='" + this.element.attr('id') +
        ...
        _onSliderOptionChange: function (e, ui) {
          ...
          newColor = new Color({ h: hue, s: sat, l: lum, a: alpha });
        ...
        _setSpectrumMask: function () {
          ...
          switch (ai.browser) {
            case oj.AgentUtils.BROWSER.FIREFOX : rep = 'moz';
              break;
        ...
        _getSatLumSpectrumPosition: function (sat, lum) {
          ...
          var lumPos = this._spectrumHeight - Math.min(((lum / 100) * this._spectrumHeight),
                                                       this._spectrumHeight);
        ...
        */
        ...
        _moveThumb: function (xDelta, yDelta) {
          ...
          // Ensure that the thumb center hasn't gone outside the spectrum
        ...
        _keyDown: function (e) {
          ...
          if (this._keyStart < 0) { // start new typeamatic period
        ...
        _initThumbDraggable: function () {
          ...
          this._$spectrumThumb.draggable({
            ...
            stop: this._thumbDragHandler
            // Note: cannot use "containment" option currently,
        ...
        _thumbDrag: function (e, ui) {
          ...
          // Constrain the thumb center to inside the spectrum
        ...
        _handleThumbMoved: function (e, xCenter, yCenter) {
          ...
          // Fire value optionChange event.
          var color = new Color({ h: hue, s: sat, l: lum, a: this._alphaVal });
  ...
  //-------------------------------------------------------------------------------------
          ...
          //  Apply the saturation/luminosity mask
          this._setSpectrumMask();

          // Paint the spectrum and move the thumb to its initial position based
        ...
        _initData: function () {
          ...
          var thumbDesc = this._EscapeXSS(this.getTranslatedString(TRANSKEY_THUMB_DESC));
          ...
          this._markup = (function () {
            return [
              ...
              "<input class='oj-colorspectrum-alpha' aria-label='" + alphaTitle + "'></input>",
              '</div>'
            ].join('');
          }());
        ...
        _enableSliders: function (enable) {
          ...
          if (enable) {
            ...
            // Need to restablish JQ pointers since they are now invalid!
            var subId = { subId: 'oj-slider-bar' };
            this._$hueSlider = this._$boundElem.find('.oj-colorspectrum-hue');
            this._$alphaSlider = this._$boundElem.find('.oj-colorspectrum-alpha');
            this._$hueBarBack = $(this._$hueSlider.ojSlider('getNodeBySubId', subId));
            this._$alphaBarBack = $(this._$alphaSlider.ojSlider('getNodeBySubId', subId));
