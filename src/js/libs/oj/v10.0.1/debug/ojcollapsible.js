 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'jquery', 'ojs/ojcomponentcore', 'ojs/ojcontext', 'ojs/ojdomutils', 'ojs/ojcustomelement', 'ojs/ojanimation', 'ojs/ojcustomelement-utils'], function (oj, $, Components, Context, DomUtils, ojcustomelement, ojanimation, ojcustomelementUtils) { 'use strict';
