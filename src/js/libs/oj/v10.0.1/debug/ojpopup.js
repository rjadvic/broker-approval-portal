    ...
    oj.__registerWidget('oj.ojPopup', $.oj.baseComponent,
      {
          ...
          if (!tail) {
            ...
            if (props.vertical === 'top') {
              ...
              tailVOffset -= (tailVOffset +
                DomUtils.getCSSLengthAsInt(tail.css(props.vertical)));
              // eslint-disable-next-line no-param-reassign
        ...
        _dismissalHandler: function (event) {
          ...
          if (!DomUtils.isAncestorOrSelf(launcher[0], target) &&
        ...
        _setWhenReady: function (operation) {
          ...
          this._whenReadyMediator = new ojpopupcore.PopupWhenReadyMediator(this.element, operation, 'ojPopup',
