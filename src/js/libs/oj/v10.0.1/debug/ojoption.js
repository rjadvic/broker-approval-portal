 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'ojs/ojcomponentcore', 'jquery', 'ojs/ojcustomelement', 'ojs/ojcustomelement-utils'], function (oj, ojcomponentcore, $, ojcustomelement, ojcustomelementUtils) { 'use strict';
