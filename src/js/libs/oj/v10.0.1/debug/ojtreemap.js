 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'ojs/ojcomponentcore', 'jquery', 'ojs/ojdvt-base', 'ojs/ojdvt-treeview', 'ojs/ojkeyset'], function (oj, ojcomponentcore, $, ojdvtBase, ojdvtTreeview, ojkeyset) { 'use strict';
  ...
  oj.__registerWidget('oj.ojTreemap', $.oj.dvtBaseComponent,
    {
      ...
      _GetChildStyleClasses: function () {
        ...
        styleClasses['oj-treemap-node-header'] = [
          ...
          { path: 'nodeDefaults/header/_labelStyle', property: 'TEXT' }
        ];
