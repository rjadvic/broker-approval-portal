...
oj.__registerWidget('oj.ojThematicMap', $.oj.dvtBaseComponent,
  {
    ...
    _loadResourceByUrl: function (url, bRenderOnFail) {
      ...
      import('../' + getResourceUrl(url)).then(renderCallback, bRenderOnFail ? renderCallback : null);
    },
    ...
    _loadBasemapHelper: function (basemap, layer, locale) {
      ...
      try {
        ...
        isLoaded =
          Object.keys(ThematicMap.DvtBaseMapManager.getLayerIds(basemap, layer)).length > 0;
      } catch (err) {
        isLoaded = false;
      }
