...
Obj.createSubclass(DvtOverviewDefaults, BaseComponentDefaults);
...
Obj.createSubclass(DvtOverviewEventManager, EventManager);
 ...
 * @extends {dvt.Obj}
 */
const OverviewParser = function(view)
{
  this.Init(view);
};

Obj.createSubclass(OverviewParser, Obj);
...
Obj.createSubclass(DvtOverviewStyleUtils, Obj);
...
Obj.createSubclass(OverviewUtils, Obj);
...
Obj.createSubclass(DvtOverviewRenderer, Obj);
...
DvtOverviewRenderer._createGrippy = function(overview, isVertical)
{
  ...
  if (isVertical)
  {
    var grippy = new Container(overview.getCtx(), 'vgrpy');
    var startx = 8;
  ...
  {
    grippy = new Container(overview.getCtx(), 'hgrpy');
 ...
 */
const Overview = function(context, callback, callbackObj) {
  this.Init(context, callback, callbackObj);
};

Obj.createSubclass(Overview, Container);
...
{
  Overview.superclass.Init.call(this, context);
...
Overview.prototype.getMinimumWindowWidth = function()
{
  ...
  else if (this._minimumWindowSize != null)
  {
    ...
    return Overview.MIN_WINDOW_SIZE;
};
...
Overview.prototype.getTimeAxisWidth = function()
{
  ...
  if (this._timeAxisWidth == null)
  {
    ...
    if (!isNaN(width) && width < this.Width)
      ...
      this._timeAxisWidth = Overview.DEFAULT_VERTICAL_TIMEAXIS_SIZE;
  }
...
Overview.prototype.getTimeAxisHeight = function()
{
  ...
  if (this._timeAxisHeight == null)
  {
    ...
    if (!isNaN(height) && height < this.Height)
      ...
      this._timeAxisHeight = Overview.DEFAULT_HORIZONTAL_TIMEAXIS_SIZE;
  }
