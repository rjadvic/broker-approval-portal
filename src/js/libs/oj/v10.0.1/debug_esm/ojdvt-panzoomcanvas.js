 ...
 */
const PanZoomCanvasEventManager = function(context, callback, callbackObj) {
  this.Init(context, callback, callbackObj);
};

Obj.createSubclass(PanZoomCanvasEventManager, EventManager);
...
PanZoomCanvasEventManager.prototype.OnMouseWheel = function(event) {
  ...
  if (this._zoomAnimator) {
    ...
    //partway through
    if (animator) {
      animator.setEasing(Easing.cubicOut);
    }
  }
 ...
 * @private
 */
PanZoomCanvasEventManager.prototype._handleMomentumStartTimer = function() {
  //do nothing
};
...
PanZoomCanvasEventManager.prototype.HandleImmediateTouchStartInternal = function(event) {
  if (this._callbackObj.isZoomingEnabled())
    this.TouchManager.processAssociatedTouchAttempt(event, PanZoomCanvasEventManager._ZOOM_TOUCH_KEY, this.ZoomStartTouch, this);

  if (this._callbackObj.isPanningEnabled())
    this.TouchManager.processAssociatedTouchAttempt(event, PanZoomCanvasEventManager._PAN_TOUCH_KEY, this.PanStartTouch, this);
};
...
PanZoomCanvasEventManager.prototype.HandleImmediateTouchMoveInternal = function(event) {
  if (this._callbackObj.isZoomingEnabled())
    this.TouchManager.processAssociatedTouchMove(event, PanZoomCanvasEventManager._ZOOM_TOUCH_KEY);

  if (this._callbackObj.isPanningEnabled())
    this.TouchManager.processAssociatedTouchMove(event, PanZoomCanvasEventManager._PAN_TOUCH_KEY);
...
PanZoomCanvasEventManager.prototype.HandleImmediateTouchEndInternal = function(event) {
  if (this._callbackObj.isZoomingEnabled())
    this.TouchManager.processAssociatedTouchEnd(event, PanZoomCanvasEventManager._ZOOM_TOUCH_KEY);

  if (this._callbackObj.isPanningEnabled())
    this.TouchManager.processAssociatedTouchEnd(event, PanZoomCanvasEventManager._PAN_TOUCH_KEY);
};
...
PanZoomCanvasEventManager.prototype._handlePanMove = function(xx, yy) {
  ...
  if (this._bMomentumPanning) {
    ...
    if (this._momentumStartTimer) {
      ...
      this._momentumStartTimer = new Timer(this._context, PanZoomCanvasEventManager._MOMENTUM_START_TIMER_INTERVAL, this._handleMomentumStartTimer, this, 1);
    }
...
PanZoomCanvasEventManager.prototype._handlePanEnd = function() {
  ...
  if (this._momentumStartTimer && this._momentumStartTimer.isRunning()) {
    ...
    if (!this._momentumTimer) {
      ...
      this._momentumTimer = new Timer(this._context, PanZoomCanvasEventManager._MOMENTUM_START_TIMER_INTERVAL, this._handleMomentumTimer, this);
    }
    else {
      this._momentumTimer.reset();
    }
...
/**
  ...
  */
const PanZoomCanvas = function(context, ww, hh, view)
{
  this.Init(context, ww, hh, view);
};

Obj.createSubclass(PanZoomCanvas, Container);
 ...
 *  @constructor
 */
const PanZoomCanvasKeyboardHandler = function(component, manager) {
  this.Init(component, manager);
};

Obj.createSubclass(PanZoomCanvasKeyboardHandler, KeyboardHandler);
 ...
 * @protected
 */
const PanZoomComponent = function(context, callback, callbackObj) {
  this.Init(context, callback, callbackObj);
};

Obj.createSubclass(PanZoomComponent, BaseComponent);
...
PanZoomComponent.prototype.Init = function(context, callback, callbackObj) {
  PanZoomComponent.superclass.Init.call(this, context, callback, callbackObj);
 ...
 * @protected
 */
PanZoomComponent.prototype.HandlePanEvent = function(event) {
 ...
 * @protected
 */
PanZoomComponent.prototype.HandleZoomEvent = function(event) {
  // subclasses should override
};
 ...
 * @protected
 */
PanZoomComponent.prototype.PreRender = function() {
  // subclasses should override
};
...
PanZoomComponent.prototype.ensureObjInViewport = function(event, navigable) {
  ...
  var animator = new Animator(this.getCtx(), this.getAnimationDuration());
