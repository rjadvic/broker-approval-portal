      ...
      remove: function (palEntry) {
        ...
        if (t === 'number') { // index
          if ((palEntry >= 0) && (palEntry < this._palette.length)) {
            ...
            error("JET Color Palette (id='" + this.element.attr('id') +
      ...
      */
      ...
      _AfterCreate: function () {
        ...
        if (label) {
          ...
          if (!labelId) {
            warn('JET Color Palette: The label for this component needs an id in order to be accessible');
          } else {
      ...
      _waitForLV: function () {
        ...
        this._LVResolve.whenReady().then(function () {
          ...
          error("JET Color Palette (id='" + self.element.attr('id') +
                             "'): ListView timed out.");
          self._opStack = [];
        });
      },
      ...
      _renderer: function (context) {
        ...
        if (!(color instanceof Color)) {
          ...
          color = Color.BLACK;
          warn("JET Color Palette (id='" + this.element.attr('id') + "'): Substituting Color.BLACK for an object that is not an instance of Color");
        }
      ...
      _SetDisplayValue: function (displayValue) {
        ...
        if (displayValue) {
          ...
          warn("JET Color Palette (id='" + this.element.attr('id') +
