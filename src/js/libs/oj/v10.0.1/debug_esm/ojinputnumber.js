  ...
  oj$1.__registerWidget('oj.ojInputNumber', $.oj.editableValue,
    {
       ...
       */
         ...
         * @type {Object}
         */
        converter: new IntlNumberConverter(null),
      /**
       * <p>
      ...
      _AfterSetOptionAsyncValidators:
        EditableValueUtils._AfterSetOptionAsyncValidators,
      /**
     ...
     */
      ...
      _createOjButtonset: function () {
        ...
        const defaultOptions = parseJSONFromFontFamily(
      ...
      _adjustValue: function (value, step, minOpt, maxOpt, stepOpt, precision, initialValue) {
        ...
        try {
          ...
          if (e instanceof TypeError) {
            ...
            warn("inputNumber's value after conversion is not a number. \n" +
  ...
  setDefaultOptions({
    ojInputNumber: {
      step: createDynamicPropertyGetter(function () {
        return (parseJSONFromFontFamily('oj-input-number-option-defaults') || {}).step;
      })
    }
  });
