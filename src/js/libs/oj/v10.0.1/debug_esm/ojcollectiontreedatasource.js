...
CollectionTreeDataSource.prototype._setCollectionInCache = function (model, collection) {
  // Tack on listeners
  collection.on(Events.EventType.ADD, this.ModelAdded, this);
  collection.on(Events.EventType.REMOVE, this.ModelRemoved, this);
  collection.on(Events.EventType.CHANGE, this.ModelUpdated, this);
  collection.on(Events.EventType.SYNC, this.CollectionRefreshed, this);
...
export default CollectionTreeDataSource;
